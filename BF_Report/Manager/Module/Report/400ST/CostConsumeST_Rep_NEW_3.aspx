<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CostConsumeST_Rep_NEW_3.aspx.cs" Inherits="BF_Report.Manager.Module.Report._400ST.CostConsumeST_Rep_NEW_3" %>
        ...
        <div>
            <table style="width: 100%;">
                <tr style="background-color: cornflowerblue; font-size: 15pt;">
                    <td width="100%;" height="30px" align="center" valign="center">烧结成本报表
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                                        ...
                                        <tr>
                                            ...
                                            <td width="80px">
                                                <dx:ASPxComboBox ID="cbbType" Font-Size="14px" runat="server" ValueType="System.String"
                                                    ...
                                                    <Items>
                                                        <dx:ListEditItem Text="360烧结" Value="S5" />
                                                        <dx:ListEditItem Text="400烧结" Value="S6" />
                                                    </Items>
                                                </dx:ASPxComboBox>
                                            </td>
                                            <td width="20px">
