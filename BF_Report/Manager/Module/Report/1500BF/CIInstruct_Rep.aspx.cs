...
{
    public partial class CIInstruct_Rep : System.Web.UI.Page
    {
        ...
        protected void GetData()
        {
            ...
            string strSQL = "";
            strSQL = "select * from T_RPT_JETCOKE where RECORD_TIME between to_date('" + strStartTime + "', 'yyyy-mm-dd hh24:mi:ss') and to_date('" + strEndTime + "', 'yyyy-mm-dd hh24:mi:ss') order by RECORD_TIME asc";
