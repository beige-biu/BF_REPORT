<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OreInput_Rep.aspx.cs" Inherits="BF_Report.Manager.Module.Report._1500BF.OreInput_Rep" %>
        ...
        <div>
            <table style="width: 100%;">
                <tr style="background-color: cornflowerblue; font-size: 15pt;">
                    <td width="100%;" height="30px" align="center" valign="center">2#高炉矿石投料日报表
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                                            ...
                                            <Columns>
                                                ...
                                                <dx:GridViewBandColumn Caption="烧结矿(t)" VisibleIndex="7">
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataTextColumn Caption="SF7" FieldName="SF7_SET_WEIGHT" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            Width="65px" VisibleIndex="6" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="SF8" FieldName="SF8_SET_WEIGHT" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            Width="65px" VisibleIndex="7" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="SF9" FieldName="SF9_SET_WEIGHT" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            Width="65px" VisibleIndex="8" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="SF10" FieldName="SF10_SET_WEIGHT" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                ...
                                                <dx:GridViewBandColumn Caption="焦丁(t)" VisibleIndex="10">
                                                    <Columns>
                                                        <dx:GridViewDataTextColumn Caption="CFD1" FieldName="CFD1_SET_WEIGHT" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            Width="65px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="CFD2" FieldName="CFD2_SET_WEIGHT" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            Width="65px" VisibleIndex="1" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="总计" FieldName="CFD_SUM" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            Width="65px" VisibleIndex="2" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                        </dx:GridViewDataTextColumn>
                                                    </Columns>
                                                </dx:GridViewBandColumn>
