<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Main_Rep.aspx.cs" Inherits="BF_Report.Manager.Module.Report._1500BF.Main_Rep" %>
                ...
                <tr>
                    ...
                    <td width="60%">
                        <dx:ASPxGridView ID="gridBase1" runat="server" ClientInstanceName="gridBase1" Width="100%" Theme="Office2010Blue" OnHtmlRowPrepared="gridBase1_HtmlRowPrepared" Font-Size="14px">
                            ...
                            <Columns>
                                <dx:GridViewBandColumn Caption="2#高炉主要设计经济技术指标" VisibleIndex="1">
                                    <Columns>
