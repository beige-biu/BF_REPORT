<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BFRun2_Rep.aspx.cs" Inherits="BF_Report.Manager.Module.Report._1500BF.BFRun2_Rep" %>
                                                    ...
                                                    <dx:ASPxGridView ID="gridBase1" runat="server" ClientInstanceName="gridBase1" Width="100%" Theme="Office2010Blue" OnHtmlRowPrepared="gridBase1_HtmlRowPrepared" Font-Size="14px">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="料批" VisibleIndex="3">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="批" FieldName="ACCUM_CHARGE" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="70px" VisibleIndex="0">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>

<%--                                                            <dx:GridViewDataTextColumn Caption="班次" FieldName="WORK_SHIFT" Width="60px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                VisibleIndex="1" >
                                                                <HeaderStyle Wrap="False" />
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="班别" FieldName="WORK_TEAM" Width="60px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                VisibleIndex="2">
                                                            </dx:GridViewDataTextColumn>
