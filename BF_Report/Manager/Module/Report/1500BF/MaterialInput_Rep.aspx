<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaterialInput_Rep.aspx.cs" Inherits="BF_Report.Manager.Module.Report._1500BF.MaterialInput_Rep" %>
        ...
        <div>
            <table style="width: 100%;">
                <tr style="background-color: cornflowerblue; font-size: 15pt;">
                    <td width="100%;" height="30px" align="center" valign="center">2#高炉入炉原燃料日报表
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                                                    ...
                                                    <dx:ASPxGridView ID="gridBase1" runat="server" ClientInstanceName="gridBase1" Width="100%" Theme="Office2010Blue" OnHtmlRowPrepared="gridBase1_HtmlRowPrepared" Font-Size="14px">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="烧结矿" VisibleIndex="3" Name="gbc1">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="重量" FieldName="SUM_SF" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            ...
                                                            <dx:GridViewBandColumn Caption="球团矿" VisibleIndex="4" Name="gbc2">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="总湿重" FieldName="SUM_WET_AF" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="65px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="总干重" FieldName="SUM_AF" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                    ...
                                                                    <dx:GridViewDataTextColumn Caption="湿重" FieldName="AF_WET_WEIGHT1" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="65px" VisibleIndex="3" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="干重" FieldName="AF_WEIGHT1" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                    ...
                                                                    <dx:GridViewDataTextColumn Caption="湿重" FieldName="AF_WET_WEIGHT2" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="65px" VisibleIndex="6" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="干重" FieldName="AF_WEIGHT2" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                    ...
                                                                    <dx:GridViewDataTextColumn Caption="湿重" FieldName="AF_WET_WEIGHT3" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="65px" VisibleIndex="9" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="干重" FieldName="AF_WEIGHT3" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            ...
                                                            <dx:GridViewBandColumn Caption="块矿" VisibleIndex="5" Name="gbc3">
                                                                <Columns>
                                                                     <dx:GridViewDataTextColumn Caption="总湿重" FieldName="SUM_WET_OF" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="65px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="总干重" FieldName="SUM_OF" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="65px" VisibleIndex="1" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="矿1品名" FieldName="OF_NAME1" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="100px" VisibleIndex="2">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="湿重" FieldName="OF_WET_WEIGHT1" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="65px" VisibleIndex="3" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="干重" FieldName="OF_WEIGHT1" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="65px" VisibleIndex="4" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="矿2品名" FieldName="OF_NAME2" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="100px" VisibleIndex="5">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="湿重" FieldName="OF_WET_WEIGHT2" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="65px" VisibleIndex="6" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="干重" FieldName="OF_WEIGHT2" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="65px" VisibleIndex="7" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="矿3品名" FieldName="OF_NAME3" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="8">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="湿重" FieldName="OF_WET_WEIGHT3" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="65px" VisibleIndex="9" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="干重" FieldName="OF_WEIGHT3" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="65px" VisibleIndex="10" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <dx:GridViewDataTextColumn Caption="白云石" FieldName="ZF_WEIGHT1" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                Width="65px" VisibleIndex="6" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="硅石" FieldName="ZF_WEIGHT2" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                Width="65px" VisibleIndex="6" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="石灰石" FieldName="ZF_WEIGHT3" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                Width="65px" VisibleIndex="6" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="萤石" FieldName="ZF_WEIGHT4" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                Width="65px" VisibleIndex="6" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="锰矿" FieldName="ZF_WEIGHT5" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                Width="65px" VisibleIndex="6" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="蛇纹石" FieldName="ZF_WEIGHT6" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                Width="65px" VisibleIndex="6" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="矿总量" FieldName="SUM_ORE" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                VisibleIndex="7" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="湿焦" FieldName="SUM_COKE" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                VisibleIndex="8" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="干焦" FieldName="SUM_DRY_COKE" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            ...
                                                            <dx:GridViewBandColumn Caption="焦炭1" VisibleIndex="10" Name="gbc5">
                                                                <Columns>
                                                                    ...
                                                                    <dx:GridViewDataTextColumn Caption="湿重" FieldName="COKE_WET_WEIGHT1" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="65px" VisibleIndex="1" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="干重" FieldName="COKE_WEIGHT1" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            ...
                                                            <dx:GridViewBandColumn Caption="焦炭2" VisibleIndex="11" Name="gbc6">
                                                                <Columns>
                                                                    ...
                                                                    <dx:GridViewDataTextColumn Caption="湿重" FieldName="COKE_WET_WEIGHT2" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="65px" VisibleIndex="1" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="干重" FieldName="COKE_WEIGHT2" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="65px" VisibleIndex="2" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <dx:GridViewBandColumn Caption="焦炭3" VisibleIndex="12" Name="gbc7">
                                                                <Columns>
                                                                    ...
                                                                    <dx:GridViewDataTextColumn Caption="湿重" FieldName="COKE_WET_WEIGHT3" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="65px" VisibleIndex="1" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="干重" FieldName="COKE_WEIGHT3" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="65px" VisibleIndex="2" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <dx:GridViewBandColumn Caption="焦丁总量" VisibleIndex="13" Name="gbc10">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="湿重" FieldName="COKE_WEIGHT6" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="65px" VisibleIndex="1" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="干重" FieldName="COKE_WEIGHT7" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="65px" VisibleIndex="2" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <dx:GridViewBandColumn Caption="回收焦丁" VisibleIndex="13" Name="gbc8">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="湿重" FieldName="SUM_WET_CFD" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="65px" VisibleIndex="1" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="干重" FieldName="SUM_CFD" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="65px" VisibleIndex="2" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <dx:GridViewBandColumn Caption="外购焦丁" VisibleIndex="14" Name="gbc9">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="湿重" FieldName="SUM_WET_CFD2" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="65px" VisibleIndex="1" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="干重" FieldName="SUM_CFD2" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="65px" VisibleIndex="2" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <dx:GridViewDataTextColumn Caption="煤粉" FieldName="SUM_COKEJET" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
