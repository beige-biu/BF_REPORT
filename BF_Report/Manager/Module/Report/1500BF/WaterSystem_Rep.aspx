<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WaterSystem_Rep.aspx.cs" Inherits="BF_Report.Manager.Module.Report._1500BF.WaterSystem_Rep" %>
        ...
        <div>
            <table style="width: 100%;">
                <tr style="background-color: cornflowerblue; font-size: 15pt;">
                    <td width="100%;" height="30px" align="center" valign="center">2#高炉水系统日报表
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                                                    ...
                                                    <dx:ASPxGridView ID="gridBase1" runat="server" ClientInstanceName="gridBase1" Width="100%" Theme="Office2010Blue" OnHtmlRowPrepared="gridBase1_HtmlRowPrepared" Font-Size="14px">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="高炉本体软水供水泵组出水总管" VisibleIndex="2">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="流量" FieldName="FT6102" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="65px" VisibleIndex="0">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="流量_1" FieldName="FT6101" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="65px" VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="温度" FieldName="TE6101" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="60px" VisibleIndex="2">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="压力" FieldName="PT6101" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            ...
                                                            <dx:GridViewBandColumn Caption="高炉净环低压泵组出水总管" VisibleIndex="3">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="流量" FieldName="FT6002" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="70px" VisibleIndex="0">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="温度" FieldName="TE6002" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="70px" VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="压力" FieldName="PT6002" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            ...
                                                            <dx:GridViewBandColumn Caption="高炉炉体热风阀软水回水总管" VisibleIndex="4">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="温度" FieldName="TE6103" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="60px" VisibleIndex="0">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="压力" FieldName="PT6103" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            ...
                                                            <dx:GridViewBandColumn Caption="高炉小套高压泵组出水总管" VisibleIndex="5">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="流量" FieldName="FT6001" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="70px" VisibleIndex="0">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="温度" FieldName="TE6001" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="70px" VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="压力" FieldName="PT6001" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="70px" VisibleIndex="2">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <dx:GridViewBandColumn Caption="净环旁滤泵组出水总管" VisibleIndex="6">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="流量" FieldName="FT6003" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="60px" VisibleIndex="0">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="温度" FieldName="TE6003" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="60px" VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="压力" FieldName="PT6003" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="60px" VisibleIndex="2">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <%--<dx:GridViewDataTextColumn Caption="净环强制排污水管流量" FieldName="FT6005" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                Width="60px" VisibleIndex="7">
                                                            </dx:GridViewDataTextColumn>--%>
                                                            <dx:GridViewBandColumn Caption="热水上塔泵组出水总管" VisibleIndex="8">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="流量" FieldName="FT6004" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="60px" VisibleIndex="0">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="温度" FieldName="TE6004" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="60px" VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="压力" FieldName="PT6004" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="60px" VisibleIndex="2">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <dx:GridViewBandColumn Caption="软水事故供水泵组出水总管" VisibleIndex="9">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="流量" FieldName="FT6106" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="70px" VisibleIndex="0">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="温度" FieldName="TE6106" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="70px" VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="压力" FieldName="PT6106" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="70px" VisibleIndex="2">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <dx:GridViewDataTextColumn Caption="软水箱补厂区软水管道流量" FieldName="FT6113" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                Width="60px" VisibleIndex="10">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewBandColumn Caption="软水补水供水泵组出水总管" VisibleIndex="11">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="流量" FieldName="FT6107" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="70px" VisibleIndex="0">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="温度" FieldName="TE6107" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="70px" VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="压力" FieldName="PT6107" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="70px" VisibleIndex="2">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <dx:GridViewBandColumn Caption="高炉低压净循环供水泵电流" VisibleIndex="12">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="1#" FieldName="AMP_GSB_M1" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="60px" VisibleIndex="0">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="2#" FieldName="AMP_GSB_M2" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="60px" VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <dx:GridViewBandColumn Caption="净环冷却塔电流" VisibleIndex="13">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="1#" FieldName="AMP_LQT_M1" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="60px" VisibleIndex="0">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="2#" FieldName="AMP_LQT_M2" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="60px" VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <dx:GridViewBandColumn Caption="软水箱液位" VisibleIndex="14">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="1#" FieldName="LT6111" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="60px" VisibleIndex="0">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="2#" FieldName="LT6112" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="60px" VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                           ...
                                                           <%-- <dx:GridViewBandColumn Caption="2#冷却塔" VisibleIndex="16">
                                                            ...
                                                            <dx:GridViewBandColumn Caption="厂区生产水补水管流量" VisibleIndex="17">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="S1" FieldName="FT6006" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="60px" VisibleIndex="0">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="S8" FieldName="FT6007" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="60px" VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <dx:GridViewBandColumn Caption="膨胀管液位" VisibleIndex="18">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="高炉" FieldName="LT_BF_PZG" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="60px" VisibleIndex="0">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="热风炉" FieldName="LT_HS_PZG" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="60px" VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <dx:GridViewDataTextColumn Caption="净环冷水池液位" FieldName="LT6011" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                Width="60px" VisibleIndex="19">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="净环热水池液位" FieldName="LT6012" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                Width="60px" VisibleIndex="20">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewBandColumn Caption="空冷器出水管" VisibleIndex="21">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="温度1" FieldName="TE6104" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="60px" VisibleIndex="0">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="温度2" FieldName="TE6105" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="60px" VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="压力1" FieldName="PT6104" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="60px" VisibleIndex="2">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="压力2" FieldName="PT6105" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="60px" VisibleIndex="3">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <dx:GridViewDataTextColumn Caption="生产新水流量" FieldName="FT_SCS" ShowInCustomizationForm="True" UnboundType="Decimal"
