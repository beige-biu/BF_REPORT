<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HSDay_Rep.aspx.cs" Inherits="BF_Report.Manager.Module.Report._1500BF.HSDay_Rep" %>
...
<body>
    <style>
        #cbp_Base_gridBase1_col31 >table,#cbp_Base_gridBase1_col32 >table {
        ...
        <div>
            <table style="width: 100%;">
                <tr style="background-color: cornflowerblue; font-size: 15pt;">
                    <td width="100%;" height="30px" align="center" valign="center">2#高炉热风炉生产日报表
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                                                    ...
                                                    <dx:ASPxGridView ID="gridBase1" runat="server" ClientInstanceName="gridBase1" Width="100%" Theme="Office2010Blue" OnHtmlRowPrepared="gridBase1_HtmlRowPrepared" Font-Size="14px">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="换热器" VisibleIndex="27">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="前煤气进口温度(℃)" FieldName="T_GAS_INLET" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="后煤气主管温度(℃)" FieldName="T_GAS_OUTLET" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="2">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="前空气进口温度(℃)" FieldName="T_AIR_INLET" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="3">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="废气进口温度(℃)" FieldName="T_AIR_OUTLET" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="4">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="废气进口温度(℃)" FieldName="T_SMOKE_INLET" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="5">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="废空气侧出口温度(℃)" FieldName="T_SMOKE_AIR_OUTLET" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="6">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="废煤气侧出口温度(℃)" FieldName="T_SMOKE_GAS_OUTLET" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="7">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
