<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProdDay_Rep.aspx.cs" Inherits="BF_Report.Manager.Module.Report._1500BF.ProdDay_Rep" %>
        ...
        <div>
            <table style="width: 100%;">
                <tr style="background-color: cornflowerblue; font-size: 15pt;">
                    <td width="100%;" height="30px" align="center" valign="center">2#高炉生产作业日报表
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                                ...
                                <td>
                                    <table style="width: 100%; height: 35px;" valign="center">
                                        <tr>
                                            ...
                                            <td width="100%">&nbsp;</td>
                                            <td width="100px">
                                                <dx:ASPxLabel ID="ASPxLabel4" runat="server" Text="R61-222/0-20" Width="100px">
                                                </dx:ASPxLabel>
                                            </td>
                                        </tr>
                                    </table>
                                                            ...
                                                            <dx:GridViewBandColumn ShowInCustomizationForm="True" Caption="送风制度" VisibleIndex="2">
                                                                <Columns>
                                                                    ...
                                                                    <dx:GridViewBandColumn ShowInCustomizationForm="True" Caption="高压富氧" VisibleIndex="9">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn FieldName="field11" UnboundType="String" ShowInCustomizationForm="True" Caption="m³" Width="75px" VisibleIndex="11" PropertiesTextEdit-DisplayFormatString="{0:0}" />
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                                    <dx:GridViewBandColumn ShowInCustomizationForm="True" Caption="机前富氧" VisibleIndex="10">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn FieldName="field12" UnboundType="String" ShowInCustomizationForm="True" Caption="m³" Width="75px" VisibleIndex="11" PropertiesTextEdit-DisplayFormatString="{0:0}" />
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>

                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <dx:GridViewDataTextColumn FieldName="field13" UnboundType="String" ShowInCustomizationForm="True" Caption="煤气利用率" Width="65px" VisibleIndex="3"></dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn FieldName="field14" UnboundType="String" ShowInCustomizationForm="True" Caption="炉基温度<br>℃" Width="65px" VisibleIndex="4"></dx:GridViewDataTextColumn>
                                                            <dx:GridViewBandColumn ShowInCustomizationForm="True" Caption="渣铁情况" VisibleIndex="5">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn FieldName="field15" UnboundType="String" ShowInCustomizationForm="True" Caption="铁次" Width="80px" VisibleIndex="0"></dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn FieldName="field16" UnboundType="String" ShowInCustomizationForm="True" Caption="铁口" Width="65px" VisibleIndex="1"></dx:GridViewDataTextColumn>
                                                                    <dx:GridViewBandColumn ShowInCustomizationForm="True" Caption="出铁时间" VisibleIndex="2">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn FieldName="field17" UnboundType="String" ShowInCustomizationForm="True" Caption="开始" Width="60px" VisibleIndex="3"></dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn FieldName="field18" UnboundType="String" ShowInCustomizationForm="True" Caption="来渣" Width="55px" VisibleIndex="4"></dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn FieldName="field19" UnboundType="String" ShowInCustomizationForm="True" Caption="结束" Width="55px" VisibleIndex="5"></dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                                    <dx:GridViewBandColumn ShowInCustomizationForm="True" Caption="产量" VisibleIndex="3">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn FieldName="field20" UnboundType="String" ShowInCustomizationForm="True" Caption="估产" Width="70px" VisibleIndex="6"></dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn FieldName="field21" UnboundType="String" ShowInCustomizationForm="True" Caption="实产" Width="70px" VisibleIndex="7"></dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                                    <dx:GridViewBandColumn ShowInCustomizationForm="True" Caption="渣铁物化性能" VisibleIndex="4">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn FieldName="field22" UnboundType="String" ShowInCustomizationForm="True" Caption="Si" Width="55px" VisibleIndex="8"></dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn FieldName="field23" UnboundType="String" ShowInCustomizationForm="True" Caption="S" Width="55px" VisibleIndex="9"></dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn FieldName="field24" UnboundType="String" ShowInCustomizationForm="True" Caption="P" Width="55px" VisibleIndex="10"></dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn FieldName="field25" UnboundType="String" ShowInCustomizationForm="True" Caption="等级" Width="55px" VisibleIndex="11"></dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn FieldName="field26" UnboundType="String" ShowInCustomizationForm="True" Caption="温度" Width="55px" VisibleIndex="12"></dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn FieldName="field27" UnboundType="String" ShowInCustomizationForm="True" Caption="Ktp" Width="55px" VisibleIndex="13"></dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn FieldName="field28" UnboundType="String" ShowInCustomizationForm="True" Caption="渣色" Width="55px" VisibleIndex="14"></dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                                    <dx:GridViewBandColumn ShowInCustomizationForm="True" Caption="炉渣成分" VisibleIndex="5">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn FieldName="field29" UnboundType="String" ShowInCustomizationForm="True" Caption="CaO" Width="55px" VisibleIndex="8"></dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn FieldName="field30" UnboundType="String" ShowInCustomizationForm="True" Caption="SiO2" Width="55px" VisibleIndex="9"></dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn FieldName="field31" UnboundType="String" ShowInCustomizationForm="True" Caption="MgO" Width="55px" VisibleIndex="10"></dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn FieldName="field32" UnboundType="String" ShowInCustomizationForm="True" Caption="Al2O3" Width="55px" VisibleIndex="11"></dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn FieldName="field33" UnboundType="String" ShowInCustomizationForm="True" Caption="FeO" Width="55px" VisibleIndex="12"></dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn FieldName="field34" UnboundType="String" ShowInCustomizationForm="True" Caption="R2" Width="55px" VisibleIndex="13"></dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn FieldName="field35" UnboundType="String" ShowInCustomizationForm="True" Caption="镁铝比" Width="65px" VisibleIndex="14"></dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                                    <dx:GridViewDataTextColumn FieldName="field36" UnboundType="String" ShowInCustomizationForm="True" Caption="深度" Width="55px" VisibleIndex="6"></dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn FieldName="field37" UnboundType="String" ShowInCustomizationForm="True" Caption="角度" Width="55px" VisibleIndex="7"></dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn FieldName="OXY_AMOUNT" UnboundType="String" ShowInCustomizationForm="True" Caption="泥量" Width="55px" VisibleIndex="8"></dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn FieldName="R_LG_ACTIVE" UnboundType="String" ShowInCustomizationForm="True" Caption="带流" Width="55px" VisibleIndex="9"></dx:GridViewDataTextColumn>
