<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HSChangeDetail_Rep.aspx.cs" Inherits="BF_Report.Manager.Module.Report._1500BF.HSChangeDetail_Rep" %>
        ...
        <div>
            <table style="width: 100%;">
                <tr style="background-color: cornflowerblue; font-size: 15pt;">
                    <td width="100%;" height="30px" align="center" valign="center">2#高炉热风炉交换作业明细日报表
                    </td>
                </tr>
                <tr>
                    <td valign="top">
