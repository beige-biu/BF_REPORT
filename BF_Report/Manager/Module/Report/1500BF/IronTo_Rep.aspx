<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IronTo_Rep.aspx.cs" Inherits="BF_Report.Manager.Module.Report._1500BF.IronTo_Rep" %>
        ...
        <div>
            <table style="width: 100%;">
                <tr style="background-color: cornflowerblue; font-size: 15pt;">
                    <td width="100%;" height="30px" align="center" valign="center">2#高炉铁水热装日报表
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                                    ...
                                    <table style="width: 100%; height: 35px;" valign="center">
                                        <tr>
                                            <tr>
                                                ...
                                                <td width="100%">&nbsp;</td>
                                                <td width="100px">
                                                    <dx:ASPxLabel ID="ASPxLabel5" runat="server" Text="F61-113/0-13" Width="100px">
                                                    </dx:ASPxLabel>
                                                </td>
                                            </tr>
                                    </table>
                                            ...
                                            <PanelCollection>
                                                <dx:PanelContent ID="PanelContent1" runat="server" SupportsDisabledAttribute="True">
                                                    <dx:ASPxGridView ID="gridBase1" runat="server" ClientInstanceName="gridBase1" Width="100%" Theme="Office2010Blue" OnHtmlRowPrepared="gridBase1_HtmlRowPrepared" OnCustomCellMerge="gridBase1_CustomCellMerge" Font-Size="14px">
                                                        ...
                                                        <Columns>                                                            
                                                            <dx:GridViewDataTextColumn Caption="日期" FieldName="field0" Width="140px" ShowInCustomizationForm="false" UnboundType="String"
                                                                VisibleIndex="0">
                                                            ...
                                                            <dx:GridViewDataTextColumn Caption="出铁重量" FieldName="field12" Width="80px" ShowInCustomizationForm="false" UnboundType="String"
                                                                VisibleIndex="3">
                                                                <Settings AllowCellMerge="True" />
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewBandColumn Caption="一炼钢" VisibleIndex="4">
                                                                <Columns>
                                                                    ...
                                                                    <dx:GridViewDataTextColumn FieldName="field5" UnboundType="String" ShowInCustomizationForm="True" Width="80px" Caption="过磅t" VisibleIndex="1"></dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="二炼钢" VisibleIndex="5">
                                                                <Columns>
                                                                    ...
                                                                    <dx:GridViewDataTextColumn FieldName="field7" UnboundType="String" ShowInCustomizationForm="True" Width="80px" Caption="过磅t" VisibleIndex="1"></dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <dx:GridViewBandColumn Caption="三期炼钢" VisibleIndex="6">
                                                                <Columns>
                                                                    ...
                                                                    <dx:GridViewDataTextColumn FieldName="field9" UnboundType="String" ShowInCustomizationForm="True" Width="80px" Caption="过磅t" VisibleIndex="1"></dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <dx:GridViewBandColumn Caption="混铸" VisibleIndex="7">
                                                                <Columns>
                                                                    ...
                                                                    <dx:GridViewDataTextColumn FieldName="field11" UnboundType="String" ShowInCustomizationForm="True" Width="80px" Caption="过磅t" VisibleIndex="1"></dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                        </Columns>
