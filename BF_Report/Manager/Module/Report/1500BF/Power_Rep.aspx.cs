...
{
    public partial class Power_Rep : System.Web.UI.Page
    {
        ...
        protected void GetData(string strHeight)
        {
            ...
            //{
            //    strSQL = " SELECT RECORD_TIME,WORK_SHIFT,WORK_TEAM ,ROUND(GL_GAS_OUT/10000,3) AS GL_GAS_OUT ,OXY_AMOUNT,N2_AMOUNT ,NATURAL_GAS_AMOUNT,ROUND(GL_GAS_USED/10000,3) AS GL_GAS_USED,AIR_AMOUNT,STEAM_AMOUNT,ROUND(BLAST_AMOUNT/10000,3) AS BLAST_AMOUNT,SOFT_WATER_AMOUNT,INDUSTRY_WATER_AMOUNT,TRT_AMOUNT,N2_PIPE_AMOUNT,YD_AMOUNT,FXDN_OUT,BF1280_AIR_AMOUNT FROM T_RPT_ENERGY_CONSUME_SUM_FAL  where RECORD_TIME between to_date('" + strStartTime + "', 'yyyy-mm-dd hh24:mi:ss') and to_date('" + strEndTime + "', 'yyyy-mm-dd hh24:mi:ss')";
            //    strSQL += " order by RECORD_TIME asc";
            //}
            //else if (Convert.ToDateTime(strStartTime) >= Convert.ToDateTime("2020-11-11 20:00:00"))
            //{
            //    strSQL = "SELECT RECORD_TIME,WORK_SHIFT,WORK_TEAM ,ROUND(GL_GAS_OUT/10000,3) AS GL_GAS_OUT ,OXY_AMOUNT,N2_AMOUNT ,NATURAL_GAS_AMOUNT,ROUND(GL_GAS_USED/10000,3) AS GL_GAS_USED,AIR_AMOUNT,STEAM_AMOUNT,ROUND(BLAST_AMOUNT/10000,3) AS BLAST_AMOUNT,SOFT_WATER_AMOUNT,INDUSTRY_WATER_AMOUNT,TRT_AMOUNT,N2_PIPE_AMOUNT,YD_AMOUNT,FXDN_OUT,BF1280_AIR_AMOUNT FROM T_RPT_ENERGY_CONSUME_SUM  where RECORD_TIME between to_date('" + strStartTime + "', 'yyyy-mm-dd hh24:mi:ss') and to_date('" + strEndTime + "', 'yyyy-mm-dd hh24:mi:ss') ";
            //    strSQL += " order by RECORD_TIME asc";
            //}
            ...
            //    strSQL += " union ";
            //    strSQL += "SELECT RECORD_TIME,WORK_SHIFT,WORK_TEAM ,ROUND(GL_GAS_OUT/10000,3) AS GL_GAS_OUT ,OXY_AMOUNT,N2_AMOUNT ,NATURAL_GAS_AMOUNT,ROUND(GL_GAS_USED/10000,3) AS GL_GAS_USED,AIR_AMOUNT,STEAM_AMOUNT,ROUND(BLAST_AMOUNT/10000,3) AS BLAST_AMOUNT,SOFT_WATER_AMOUNT,INDUSTRY_WATER_AMOUNT,TRT_AMOUNT,N2_PIPE_AMOUNT,YD_AMOUNT,FXDN_OUT,BF1280_AIR_AMOUNT FROM T_RPT_ENERGY_CONSUME_SUM  where RECORD_TIME between to_date('2020-11-11 20:00:01', 'yyyy-mm-dd hh24:mi:ss') and to_date('" + strEndTime + "', 'yyyy-mm-dd hh24:mi:ss') ";
            //    strSQL += " )order by RECORD_TIME asc";
            //}
            //原始代码
            strSQL = " SELECT RECORD_TIME,WORK_SHIFT,WORK_TEAM ,GL_GAS_OUT ,OXY_AMOUNT,N2_AMOUNT ,NATURAL_GAS_AMOUNT,GL_GAS_USED,AIR_AMOUNT,STEAM_AMOUNT,BLAST_AMOUNT,SOFT_WATER_AMOUNT,INDUSTRY_WATER_AMOUNT,TRT_AMOUNT,N2_PIPE_AMOUNT,YD_AMOUNT,FXDN_OUT,BF1280_AIR_AMOUNT FROM T_RPT_ENERGY_CONSUME_SUM where RECORD_TIME between to_date('" + strStartTime + "', 'yyyy-mm-dd hh24:mi:ss') and to_date('" + strEndTime + "', 'yyyy-mm-dd hh24:mi:ss') order by RECORD_TIME asc";
