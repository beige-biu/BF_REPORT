<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CIInstruct_Rep.aspx.cs" Inherits="BF_Report.Manager.Module.Report._1500BF.CIInstruct_Rep" %>
        ...
        <div>
            <table style="width: 100%;">
                <tr style="background-color: cornflowerblue; font-size: 15pt;">
                    <td width="100%;" height="30px" align="center" valign="center">2#高炉喷煤日报表
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                                                ...
                                                <dx:PanelContent ID="PanelContent1" runat="server" SupportsDisabledAttribute="True">
                                                    <dx:ASPxGridView ID="gridBase1" runat="server" ClientInstanceName="gridBase1" Width="100%" Theme="Office2010Blue" OnHtmlRowPrepared="gridBase1_HtmlRowPrepared" Font-Size="14px">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dx:GridViewDataTextColumn Caption="大喷煤<br>(t/h)" FieldName="COKE_AMOUNT" Width="65px" ShowInCustomizationForm="false" UnboundType="String"
                                                                VisibleIndex="3">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="小喷煤<br>(t/h)" FieldName="COKE_AMOUNT1" Width="65px" ShowInCustomizationForm="false" UnboundType="String"
                                                                VisibleIndex="3">
                                                            </dx:GridViewDataTextColumn>
                                                        ...
                                                        <GroupSummary>
                                                            ...
                                                            <dx:ASPxSummaryItem FieldName="COKE_AMOUNT1" ShowInGroupFooterColumn="COKE_AMOUNT1" SummaryType="Sum" DisplayFormat="{0:0.00}" />
                                                            ...
                                                            <dx:ASPxSummaryItem FieldName="P_N2_REAL" ShowInGroupFooterColumn="P_N2_REAL" SummaryType="Average" DisplayFormat="{0:0.00}" />
                                                            <dx:ASPxSummaryItem FieldName="T_N2_REAL" ShowInGroupFooterColumn="T_N2_REAL" SummaryType="Average" DisplayFormat="{0:0.00}" />
