<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="STMaterial_Ratio_Rep_1.aspx.cs" Inherits="BF_Report.Manager.Module.Report._360ST.STMaterial_Ratio_Rep_1" %>
                                            ...
                                            <PanelCollection>
                                                <dx:PanelContent ID="PanelContent1" runat="server" SupportsDisabledAttribute="True">
                                                    <dx:ASPxGridView ID="gridBase1" runat="server" ClientInstanceName="gridBase1" Width="100%" Theme="Office2010Blue" OnHtmlRowPrepared="gridBase1_HtmlRowPrepared" Font-Size="14px">
                                                        ...
                                                        <Columns>
                                                            <dx:GridViewDataTextColumn Caption="配比单号" FieldName="INGREDIENT_NO" Width="170px" ShowInCustomizationForm="false" UnboundType="String"
                                                            ...
                                                            <dx:GridViewDataTextColumn Caption="物料配比(%)" FieldName="MATERIAL_RATE" Width="65px" ShowInCustomizationForm="true" UnboundType="String"
                                                                VisibleIndex="3" >                                                                 
                                                            </dx:GridViewDataTextColumn>
                                                           <dx:GridViewDataTextColumn Caption="开堆时间" FieldName="BEGIN_STORE_DATE" Width="175px" ShowInCustomizationForm="true" UnboundType="String"
                                                            ...
                                                            <%--<dx:GridViewDataTextColumn Caption="记录时间" FieldName="SENDER_TIME" Width="175px" ShowInCustomizationForm="true" UnboundType="String"
                                                                VisibleIndex="5" > 
                                                                <PropertiesTextEdit DisplayFormatString="yyyy-MM-dd HH:mm:ss"></PropertiesTextEdit>
                                                            </dx:GridViewDataTextColumn>--%>
                                                        ...
                                                        <TotalSummary>
                                                            <dx:ASPxSummaryItem FieldName="INGREDIENT_NO" ShowInGroupFooterColumn="INGREDIENT_NO" SummaryType="Count" DisplayFormat="合计" />
                                                            <dx:ASPxSummaryItem FieldName="MATERIAL_RATE" ShowInGroupFooterColumn="MATERIAL_RATE" SummaryType="sum" DisplayFormat="{0:0.00}" />                                                          
                                                        </TotalSummary>
