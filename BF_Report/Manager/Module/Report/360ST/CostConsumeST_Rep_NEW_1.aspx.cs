...
{
    public partial class CostConsumeST_Rep_NEW_1 : System.Web.UI.Page
    {
        ...
        public void GetSum(string ID, out string a, out string b, out string c)
        {
            ...
            if (p_no == "D0")
            {
                ...
                string strsql = "SELECT SUM(NVL(WET_WGT,0)) AS WGT FROM L2BF_COM.T_HYKPB_USED_MON WHERE PRODCODE='" + ID + "' AND WORK_DATE='" + strStartTime + "' and PROC_UNIT='S5' ";
