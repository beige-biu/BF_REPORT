<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WaterSystem_Rep_1.aspx.cs" Inherits="BF_Report.Manager.Module.Report._1280BF.WaterSystem_Rep_1" %>
                                                    ...
                                                    <dx:ASPxGridView ID="gridBase1" runat="server" ClientInstanceName="gridBase1" Width="100%" Theme="Office2010Blue" OnHtmlRowPrepared="gridBase1_HtmlRowPrepared" Font-Size="14px">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="旁滤泵组" VisibleIndex="2">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="流量" FieldName="F_PLB" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="75px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="压力" FieldName="P_PLB" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            ...
                                                            <dx:GridViewBandColumn Caption="热水提升泵组" VisibleIndex="3">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="流量" FieldName="F_RSTSB" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="75px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="温度" FieldName="T_RSTSB" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="75px" VisibleIndex="1" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="压力" FieldName="P_RSTSB" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            ...
                                                            <dx:GridViewBandColumn Caption="高炉净环高压泵组" VisibleIndex="4">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="流量" FieldName="F_JHGYSB" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="75px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="温度" FieldName="T_JHGYSB" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="75px" VisibleIndex="1" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="压力" FieldName="P_JHGYSB" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="75px" VisibleIndex="2" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <dx:GridViewBandColumn Caption="紧急补水泵组" VisibleIndex="5">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="流量" FieldName="F_JJBSB" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="75px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="温度" FieldName="T_JJBSB" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="75px" VisibleIndex="1" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                             <dx:GridViewBandColumn Caption="高炉软水闭路" VisibleIndex="6">
                                                                <Columns>
                                                                    <dx:GridViewBandColumn Caption="供水总管" VisibleIndex="0">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="流量1" FieldName="F_RSGS1" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                                Width="75px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="流量2" FieldName="F_RSGS2" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                                Width="75px" VisibleIndex="1" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="温度" FieldName="T_RSGS" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                                Width="75px" VisibleIndex="2" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="压力" FieldName="P_RSGS" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                    ...
                                                                    <dx:GridViewBandColumn Caption="回水总管" VisibleIndex="1">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="流量1" FieldName="F_RSHS1" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                                Width="75px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="流量2" FieldName="F_RSHS2" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                                Width="75px" VisibleIndex="1" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="温度" FieldName="T_RSHS" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                                Width="75px" VisibleIndex="2" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="压力" FieldName="P_RSHS" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                                Width="75px" VisibleIndex="3" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                            </dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
