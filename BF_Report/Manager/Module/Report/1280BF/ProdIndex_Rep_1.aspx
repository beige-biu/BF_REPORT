<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProdIndex_Rep_1.aspx.cs" Inherits="BF_Report.Manager.Module.Report._1280BF.ProdIndex_Rep_1" %>
...
<body>
    <style>
        #cbp_Base_gridBase1_DXHeadersRow0 > table {
                ...
                <tr>
                    <td valign="top">
                        <table style="width: 100%;" align="center" valign="top">
                                ...
                                <td>
                                    <table style="width: 100%; height: 35px;" valign="center">
                                        <tr>
                                            ...
                                            <td width="20px">
                                                <dx:ASPxLabel ID="ASPxLabel3" runat="server" Text="" Width="20px" ClientInstanceName="chromHeight">
                                                </dx:ASPxLabel>
                                            </td>
                                            <td width="80px" align="right">
                            ...
                            <tr>
                                <td colspan="4">
                                    <dx:ContentControl ID="ContentControl1" runat="server" BorderStyle="Solid" Height="151px" Width="900px">
                                                ...
                                                <dx:PanelContent ID="PanelContent1" runat="server" SupportsDisabledAttribute="True">
                                                    <dx:ASPxGridView ID="gridBase1" runat="server" ClientInstanceName="gridBase1" Width="100%" Theme="Office2010Blue" OnHtmlRowPrepared="gridBase1_HtmlRowPrepared" Font-Size="14px">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="产量" VisibleIndex="3">
                                                                <Columns>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="一级品" VisibleIndex="4">
                                                                <Columns>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="一级品率" VisibleIndex="5">
                                                                <Columns>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="系数" VisibleIndex="6">
                                                                <Columns>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="冶炼强度" VisibleIndex="7">
                                                                <Columns>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="干焦比" VisibleIndex="8">
                                                                <Columns>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="煤比" VisibleIndex="9">
                                                                <Columns>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="焦丁比" VisibleIndex="10">
                                                                <Columns>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="综合焦比" VisibleIndex="12">
                                                                <Columns>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="矿耗" VisibleIndex="13">
                                                                <Columns>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="煤气利用率" VisibleIndex="16">
                                                                <Columns>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="入炉品位" VisibleIndex="17">
                                                                <Columns>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="渣铁比" VisibleIndex="18">
                                                                <Columns>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="灰铁比" VisibleIndex="19">
                                                                <Columns>
