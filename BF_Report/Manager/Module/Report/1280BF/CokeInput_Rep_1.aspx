<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CokeInput_Rep_1.aspx.cs" Inherits="BF_Report.Manager.Module.Report._1280BF.CokeInput_Rep" %>
        ...
        <div>            
            <table style="width: 100%;">
                <tr style="background-color: cornflowerblue; font-size: 15pt;">
                    <td width="100%;" height="30px" align="center" valign="center">1#高炉焦炭投料日报表
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                                                ...
                                                <dx:PanelContent ID="PanelContent1" runat="server" SupportsDisabledAttribute="True">
                                                    <dx:ASPxGridView ID="gridBase1" runat="server" ClientInstanceName="gridBase1" Width="100%" Theme="Office2010Blue" OnHtmlRowPrepared="gridBase1_HtmlRowPrepared"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dx:GridViewDataTextColumn Caption="焦仓1(t)" FieldName="COKE1_SET_WEIGHT" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                VisibleIndex="2" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="焦仓2(t)" FieldName="COKE2_SET_WEIGHT" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                VisibleIndex="2" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="焦仓3(t)" FieldName="COKE3_SET_WEIGHT" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                VisibleIndex="2" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="焦仓4(t)" FieldName="COKE4_SET_WEIGHT" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                VisibleIndex="2" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="焦仓5(t)" FieldName="COKE5_SET_WEIGHT" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                VisibleIndex="2" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="湿焦总重(t)" FieldName="SUM_WET_COKE" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                VisibleIndex="2" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="干焦总重(t)" FieldName="SUM_DRY_COKE" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                VisibleIndex="2" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="杂矿1(t)" FieldName="ZF1_SET_WEIGHT" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                VisibleIndex="2" PropertiesTextEdit-DisplayFormatString="{0:0.00}" >
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="杂矿2(t)" FieldName="ZF2_SET_WEIGHT" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                VisibleIndex="2" PropertiesTextEdit-DisplayFormatString="{0:0.00}" >
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="杂矿总重(t)" FieldName="SUM_ZF" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                VisibleIndex="2" PropertiesTextEdit-DisplayFormatString="{0:0.00}" >
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewBandColumn Visible="false">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="" FieldName="COKE1_SUM1" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="2" Visible="false">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="" FieldName="COKE1_SUM2" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="2" Visible="false">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="" FieldName="COKE2_SUM1" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="2" Visible="false">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="" FieldName="COKE2_SUM2" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="2" Visible="false">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="" FieldName="COKE3_SUM1" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="2" Visible="false">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="" FieldName="COKE3_SUM2" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="2" Visible="false">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="" FieldName="COKE4_SUM1" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="2" Visible="false">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="" FieldName="COKE4_SUM2" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="2" Visible="false">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="" FieldName="COKE5_SUM1" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="2" Visible="false">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="" FieldName="COKE5_SUM2" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="2" Visible="false">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="" FieldName="COKE6_SUM1" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="2" Visible="false">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="" FieldName="COKE6_SUM2" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="2" Visible="false">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="" FieldName="SUM_WET1" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="2" Visible="false">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="" FieldName="SUM_WET2" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="2" Visible="false">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="" FieldName="SUM_DRY1" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="2" Visible="false">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="" FieldName="SUM_DRY2" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="2" Visible="false">
                                                                    </dx:GridViewDataTextColumn>
                                                                    ...
                                                                    <dx:GridViewDataTextColumn Caption="" FieldName="SUM_ZF1" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="2" Visible="false">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="" FieldName="SUM_ZF2" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="2" Visible="false">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                        ...
                                                        <TotalSummary>
                                                            ...
                                                            <dx:ASPxSummaryItem Tag="tag1" FieldName="ZF1_SUM1" ShowInColumn="ZF1_SET_WEIGHT" SummaryType="Sum" DisplayFormat="{0:0.00}"/>
                                                            <dx:ASPxSummaryItem Tag="tag2" FieldName="ZF1_SUM2" ShowInColumn="ZF1_SET_WEIGHT" SummaryType="Sum" DisplayFormat="{0:0.00}"/>
                                                            <dx:ASPxSummaryItem Tag="tag1" FieldName="ZF2_SUM1" ShowInColumn="ZF2_SET_WEIGHT" SummaryType="Sum" DisplayFormat="{0:0.00}"/>
                                                            <dx:ASPxSummaryItem Tag="tag2" FieldName="ZF2_SUM2" ShowInColumn="ZF2_SET_WEIGHT" SummaryType="Sum" DisplayFormat="{0:0.00}"/>
                                                            <dx:ASPxSummaryItem Tag="tag1" FieldName="SUM_ZF1" ShowInColumn="SUM_ZF" SummaryType="Sum" DisplayFormat="{0:0.00}"/>
                                                            <dx:ASPxSummaryItem Tag="tag2" FieldName="SUM_ZF2" ShowInColumn="SUM_ZF" SummaryType="Sum" DisplayFormat="{0:0.00}"/>
                                                        ...
                                                        <GroupSummary>
                                                            ...
                                                            <dx:ASPxSummaryItem Tag="tag1" FieldName="ZF1_SUM1" ShowInGroupFooterColumn="ZF1_SET_WEIGHT" SummaryType="Sum" DisplayFormat="{0:0.00}"/>
                                                            <dx:ASPxSummaryItem Tag="tag2" FieldName="ZF1_SUM2" ShowInGroupFooterColumn="ZF1_SET_WEIGHT" SummaryType="Sum" DisplayFormat="{0:0.00}"/>
                                                            <dx:ASPxSummaryItem Tag="tag1" FieldName="ZF2_SUM1" ShowInGroupFooterColumn="ZF2_SET_WEIGHT" SummaryType="Sum" DisplayFormat="{0:0.00}"/>
                                                            <dx:ASPxSummaryItem Tag="tag2" FieldName="ZF2_SUM2" ShowInGroupFooterColumn="ZF2_SET_WEIGHT" SummaryType="Sum" DisplayFormat="{0:0.00}"/>
                                                            <dx:ASPxSummaryItem Tag="tag1" FieldName="SUM_ZF1" ShowInGroupFooterColumn="SUM_ZF" SummaryType="Sum" DisplayFormat="{0:0.00}"/>
                                                            <dx:ASPxSummaryItem Tag="tag2" FieldName="SUM_ZF2" ShowInGroupFooterColumn="SUM_ZF" SummaryType="Sum" DisplayFormat="{0:0.00}"/>
