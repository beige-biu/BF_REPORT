...
{
    public partial class WaterSlag_Rep_1 : System.Web.UI.Page
    {
        ...
        protected void GetData()
        {
            ...
            string strSQL = "";
            strSQL = "select * from l2bf_db.DAY_WG  where RECORD_TIME BETWEEN TO_DATE('" + strStartTime + "','yyyy-mm-dd hh24:mi:ss') AND TO_DATE('" + strEndTime + "','yyyy-mm-dd hh24:mi:ss') ";
