<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BFRun_Rep_1.aspx.cs" Inherits="BF_Report.Manager.Module.Report._1280BF.BFRun_Rep_1" %>
                                                ...
                                                <dx:PanelContent ID="PanelContent1" runat="server" SupportsDisabledAttribute="True">
                                                    <dx:ASPxGridView ID="gridBase1" runat="server" ClientInstanceName="gridBase1" Width="100%" Theme="Office2010Blue" OnHtmlRowPrepared="gridBase1_HtmlRowPrepared" Font-Size="14px">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dx:GridViewDataTextColumn Caption="班别" FieldName="BB" Width="60px" ShowInCustomizationForm="false" UnboundType="String"
                                                                VisibleIndex="2">
                                                            </dx:GridViewDataTextColumn>
                                                             ...
                                                             <dx:GridViewBandColumn Caption="中部压差" VisibleIndex="8">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="kPa" FieldName="BOTTOM_PRESS" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="70px" VisibleIndex="0" Visible="false">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="富氧量" VisibleIndex="14">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="m³/h" FieldName="RICH_OXY_AMOUNT" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            ...
                                                            <dx:GridViewBandColumn Caption="软水压" VisibleIndex="26">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="软水压1" FieldName="P_SOFT1_WATER" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="70px" VisibleIndex="0">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="软水压2" FieldName="P_SOFT2_WATER" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            ...
                                                            <dx:GridViewBandColumn Caption="炉底中心温度" VisibleIndex="28">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="2层TE1102" FieldName="T_LD_HEART" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="70px" VisibleIndex="0">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="1层TE1101" FieldName="T_LJ_HEART" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="70px" VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="机前富氧" VisibleIndex="30">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="m³/h" FieldName="R_LG_ACTIVE" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="70px" VisibleIndex="0">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="料面下降速度" VisibleIndex="32">
                                                                <Columns>
