<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BLSJ_Rep_1.aspx.cs" Inherits="BF_Report.Manager.Module.Report._1280BF.BLSJ_Rep_1" %>
                                                    ...
                                                    <dx:ASPxGridView ID="gridBase1" runat="server" ClientInstanceName="gridBase1" Width="100%" Theme="Office2010Blue" OnHtmlRowPrepared="gridBase1_HtmlRowPrepared" Font-Size="14px">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="焦批重kg" VisibleIndex="4">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="干焦" FieldName="COKE_WEIGHT1" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="70px" VisibleIndex="0">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="湿焦" FieldName="COKE_WEIGHT2" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="70px" VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            ...
                                                            <dx:GridViewDataTextColumn Caption="焦炭1重量kg" FieldName="COKE1_WEIGHT" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            ...
                                                            <dx:GridViewDataTextColumn Caption="焦炭2重量kg" FieldName="COKE2_WEIGHT" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            ...
                                                            <dx:GridViewDataTextColumn Caption="焦炭3重量kg" FieldName="COKE3_WEIGHT" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            ...
                                                            <dx:GridViewDataTextColumn Caption="焦炭4重量kg" FieldName="COKE4_WEIGHT" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            ...
                                                            <dx:GridViewDataTextColumn Caption="焦炭5重量kg" FieldName="COKE5_WEIGHT" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                Width="70px" VisibleIndex="14">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="焦丁重量" FieldName="CFD_WEIGHT" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                Width="70px" VisibleIndex="15">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="矿批重" FieldName="ORE_WEIGHT" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            ...
                                                            <dx:GridViewDataTextColumn Caption="烧结矿重量" FieldName="SINTER_WEIGHT" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            ...
                                                            <dx:GridViewDataTextColumn Caption="球团矿1kg" FieldName="AF1_WEIGHT" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            ...
                                                            <dx:GridViewDataTextColumn Caption="球团矿2kg" FieldName="AF2_WEIGHT" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            ...
                                                            <dx:GridViewDataTextColumn Caption="块矿1kg" FieldName="OF1_WEIGHT" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            ...
                                                            <dx:GridViewDataTextColumn Caption="块矿2kg" FieldName="OF2_WEIGHT" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                Width="70px" VisibleIndex="26">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="杂矿1名称" FieldName="ZF1_NAME" ShowInCustomizationForm="True" UnboundType="String"
                                                                Width="100px" VisibleIndex="27">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="杂矿1kg" FieldName="ZF1_WEIGHT" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                Width="70px" VisibleIndex="28">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="杂矿2名称" FieldName="ZF2_NAME" ShowInCustomizationForm="True" UnboundType="String"
                                                                Width="100px" VisibleIndex="29">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="杂矿2kg" FieldName="ZF2_WEIGHT" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            ...
                                                            <dx:GridViewDataTextColumn Caption="喷煤量" FieldName="JETCOKE_WEIGHT" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                Width="70px" VisibleIndex="33">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="计算渣比" FieldName="THERY_ZB" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                Width="70px" VisibleIndex="34">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="渣中Al2O3" FieldName="SLAG_AL2O3" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                Width="100px" VisibleIndex="35">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="渣中CAO" FieldName="SLAG_CAO" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                Width="70px" VisibleIndex="36">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="渣中SIO2" FieldName="SLAG_SIO" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                Width="100px" VisibleIndex="37">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="渣中MGO" FieldName="SLAG_MGO" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            ...
                                                            <dx:GridViewDataTextColumn Caption="干焦负荷" FieldName="THERY_GJFH" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                Width="100px" VisibleIndex="40">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="批铁量" FieldName="THERY_FE" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                Width="70px" VisibleIndex="41">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="批体积" FieldName="THERY_TJ" ShowInCustomizationForm="True" UnboundType="Decimal"
