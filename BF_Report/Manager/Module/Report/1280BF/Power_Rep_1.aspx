<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Power_Rep_1.aspx.cs" Inherits="BF_Report.Manager.Module.Report._1280BF.Power_Rep_1" %>
                                                    ...
                                                    <dx:ASPxGridView ID="gridBase1" runat="server" ClientInstanceName="gridBase1" Width="100%" Theme="Office2010Blue" OnHtmlRowPrepared="gridBase1_HtmlRowPrepared" Font-Size="14px">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="压缩空气" VisibleIndex="6">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="m³" FieldName="AIR_AMOUNT" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="80px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0}">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <dx:GridViewBandColumn Caption="蒸汽" VisibleIndex="7">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="t" FieldName="STEAM_AMOUNT" ShowInCustomizationForm="True" UnboundType="Decimal"
