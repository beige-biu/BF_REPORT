<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TRTDev_Rep_1.aspx.cs" Inherits="BF_Report.Manager.Module.Report._1280BF.TRTDev_Rep_1" %>
                                                    ...
                                                    <dx:ASPxGridView ID="gridBase1" runat="server" ClientInstanceName="gridBase1" Width="100%" Theme="Office2010Blue" OnHtmlRowPrepared="gridBase1_HtmlRowPrepared" Font-Size="14px">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="煤气系统" VisibleIndex="8" Name="gbc9">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="煤气流量(Nm3/h)" FieldName="TAG24" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                        Width="65px" VisibleIndex="0">
                                                                    </dx:GridViewDataTextColumn>
