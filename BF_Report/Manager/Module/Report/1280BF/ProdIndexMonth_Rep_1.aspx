<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProdIndexMonth_Rep_1.aspx.cs" Inherits="BF_Report.Manager.Module.Report._1280BF.ProdIndexMonth_Rep_1" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table style="width: 100%;">
                <tr>
                    <td with="100%;" height="30px" align="center" valign="center" style="background-color: cornflowerblue; font-size: 15pt;">1#高炉生产技经指标月报表</td>
                </tr>
            </table>
                                ...
                                <td>
                                    <table style="width: 100%; height: 35px;" valign="center">
                                        <tr>
                                            ...
                                            <td width="100%">&nbsp;</td>
                                            <td width="100px">
                                                <dx:ASPxLabel ID="ASPxLabel5" runat="server" Text="R61-044/1-03" Width="100px">
                                                </dx:ASPxLabel>
                                            </td>
                                        </tr>
                                    </table>
                                                ...
                                                <dx:PanelContent ID="PanelContent1" runat="server" SupportsDisabledAttribute="True">
                                                    <dx:ASPxGridView ID="gridBase1" runat="server" ClientInstanceName="gridBase1" Width="100%" Theme="Office2010Blue" OnHtmlRowPrepared="gridBase1_HtmlRowPrepared" Font-Size="14px">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dx:GridViewDataTextColumn Caption="产量<br>(t)" FieldName="IRON_CL" Width="45px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                VisibleIndex="1" >
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="系数<br>(t/m³.d)" FieldName="LYZS" Width="45px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                VisibleIndex="2">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="冶强<br>(t/m³.d)" FieldName="YLQD" Width="45px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                VisibleIndex="3">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="综合冶强<br>(t/m³.d)" FieldName="ZHQD" Width="45px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                VisibleIndex="4">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="干焦比<br>(kg/t)" FieldName="GJB" Width="45px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                VisibleIndex="5">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="煤比<br>(kg/t)" FieldName="PMB" Width="45px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                VisibleIndex="6">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="焦丁比<br>(kg/t)" FieldName="JDB" Width="45px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                VisibleIndex="7">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="燃料比<br>(kg/t)" FieldName="RLB" Width="45px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                VisibleIndex="8">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="综合焦比<br>(kg/t)" FieldName="ZHJB" Width="60px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                VisibleIndex="9">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="矿耗<br>(kg/t)" FieldName="KH" Width="45px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                VisibleIndex="10">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="熔剂消耗<br>(t/t)" FieldName="RJXH" Width="45px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                VisibleIndex="11">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="负荷<br>(t/t)" FieldName="FH" Width="45px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                VisibleIndex="12">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="综合负荷<br>(t/t)" FieldName="ZHFH" Width="45px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                VisibleIndex="13">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="富氧率<br>(％)" FieldName="FYL" Width="45px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                VisibleIndex="14">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="入炉品位<br>(％)" FieldName="RLPW" Width="60px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                VisibleIndex="15">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="渣铁比<br>(kg/t)" FieldName="ZTB" Width="45px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                VisibleIndex="16">
                                                            </dx:GridViewDataTextColumn>
                                                        </Columns>
                                                        <TotalSummary>
                                                            ...
                                                            <dx:ASPxSummaryItem FieldName="GJB" ShowInGroupFooterColumn="GJB" SummaryType="Average" DisplayFormat="{0:0.00}" />
