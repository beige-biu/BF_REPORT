<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CIInstruct_Rep_1.aspx.cs" Inherits="BF_Report.Manager.Module.Report._1280BF.CIInstruct_Rep_1" %>
                                                ...
                                                <dx:PanelContent ID="PanelContent1" runat="server" SupportsDisabledAttribute="True">
                                                    <dx:ASPxGridView ID="gridBase1" runat="server" ClientInstanceName="gridBase1" Width="100%" Theme="Office2010Blue" OnHtmlRowPrepared="gridBase1_HtmlRowPrepared" Font-Size="14px">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dx:GridViewDataTextColumn Caption="喷煤量(t/h)" FieldName="COKE_AMOUNT" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                VisibleIndex="3">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="热风压力kPa" FieldName="HOTWIND_PRESS" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                VisibleIndex="4">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="喷煤速度t/h" FieldName="F_COAL_REAL" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                VisibleIndex="5">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewBandColumn Caption="氮气" VisibleIndex="6">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="流量m³/h" FieldName="F_N2_REAL" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="压力MPa" FieldName="P_N2_PIPE" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="2">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="温度℃" FieldName="T_N2_PIPE" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="3">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="分配器前" VisibleIndex="7">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="压力1MPa" FieldName="P_SEC_ADAPTOR1" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="压力2MPa" FieldName="P_SEC_ADAPTOR2" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="2">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <dx:GridViewBandColumn Caption="1#喷吹罐" VisibleIndex="8">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="压力MPa" FieldName="P_JET1" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="上温℃" FieldName="T_JET1_UP" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="2">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="下温℃" FieldName="T_JET1_LOW" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="3">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="重量t" FieldName="W_JET1" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="4">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <dx:GridViewBandColumn Caption="2#喷吹罐" VisibleIndex="9">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="压力MPa" FieldName="P_JET2" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="上温℃" FieldName="T_JET2_UP" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="2">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="下温℃" FieldName="T_JET2_LOW" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="3">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="重量t" FieldName="W_JET2" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="4">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <dx:GridViewBandColumn Caption="3#喷吹罐" VisibleIndex="10">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="压力MPa" FieldName="P_JET3" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="上温℃" FieldName="T_JET3_UP" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="2">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="下温℃" FieldName="T_JET3_LOW" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="3">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="重量t" FieldName="W_JET3" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                        VisibleIndex="4">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
