...
{
    public partial class ProdIndex_Rep_1_faliii : System.Web.UI.Page
    {
        ...
        protected void GetData()
        {
            ...
            //}
            //原始代码
            strSQL = " select * from (SELECT * from l2bf_db.DAY_JJZB_FALII t union SELECT * from l2bf_db.DAY_JJZB_FALIII t )  WHERE RECORD_TIME BETWEEN TO_DATE('" + strStartTime + "','yyyy-mm-dd hh24:mi:ss') AND TO_DATE('" + strEndTime + "','yyyy-mm-dd hh24:mi:ss')";
            strSQL += " ORDER BY RECORD_TIME ASC";
