<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IronOutput_Rep_FAL.aspx.cs" Inherits="BF_Report.Manager.Module.Report._1280BF.IronOutput_Rep_FAL" %>
                                                ...
                                                <dx:PanelContent ID="PanelContent1" runat="server" SupportsDisabledAttribute="True">
                                                    <dx:ASPxGridView ID="gridBase1" runat="server" ClientInstanceName="gridBase1" Width="100%" Theme="Office2010Blue" OnHtmlRowPrepared="gridBase1_HtmlRowPrepared" Font-Size="14px">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dx:GridViewDataTextColumn Caption="班别" FieldName="BB" Width="50px" ShowInCustomizationForm="false" UnboundType="String"
                                                                VisibleIndex="2">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="炉次" FieldName="FRUN_DEGR" Width="50px" ShowInCustomizationForm="false" UnboundType="String"
                                                                VisibleIndex="2">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="铁次" FieldName="IRON_DEGR" Width="100px" ShowInCustomizationForm="false" UnboundType="String"
                                                                VisibleIndex="3">
                                                            </dx:GridViewDataTextColumn>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="铁水实际成分" VisibleIndex="20">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="SI" FieldName="SI" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="50px" VisibleIndex="0">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="S" FieldName="S" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="50px" VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="P" FieldName="P" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="50px" VisibleIndex="2">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>

                                                            <dx:GridViewBandColumn Caption="炉渣实际成分" VisibleIndex="21">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="CaO" FieldName="CAO" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="50px" VisibleIndex="0">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="SiO2" FieldName="SIO2" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="50px" VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="MgO" FieldName="MGO" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="50px" VisibleIndex="2">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="Al2O3" FieldName="AL2O3" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="50px" VisibleIndex="3">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="FeO" FieldName="FEO" ShowInCustomizationForm="True" UnboundType="String"
                                                            ...
                                                            <dx:GridViewBandColumn Caption="铁水测温" VisibleIndex="22">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="温度1" FieldName="IRON_TEMP1" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="50px" VisibleIndex="0">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="温度2" FieldName="IRON_TEMP2" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="50px" VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
