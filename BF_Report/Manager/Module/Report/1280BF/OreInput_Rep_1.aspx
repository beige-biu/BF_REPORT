<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OreInput_Rep_1.aspx.cs" Inherits="BF_Report.Manager.Module.Report._1280BF.OreInput_Rep" %>
        ...
        <div>
            <table style="width: 100%;">
                <tr style="background-color: cornflowerblue; font-size: 15pt;">
                    <td width="100%;" height="30px" align="center" valign="center">1#高炉矿石投料日报表
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                                    ...
                                    <dx:PanelContent ID="PanelContent1" runat="server" SupportsDisabledAttribute="True">
                                        <dx:ASPxGridView ID="gridBase1" runat="server" ClientInstanceName="gridBase1" Width="100%" Theme="Office2010Blue" OnHtmlRowPrepared="gridBase1_HtmlRowPrepared" OnCustomCellMerge="gridBase1_CustomCellMerge" Font-Size="14px">
                                            ...
                                            <Columns>
                                                ...
                                                <dx:GridViewDataTextColumn Caption="矿批总重(t)" FieldName="MAT_SUM" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                    VisibleIndex="6" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                </dx:GridViewDataTextColumn>
                                                <dx:GridViewBandColumn Caption="烧结矿(t)" VisibleIndex="7">
                                                    <Columns>
                                                        <dx:GridViewDataTextColumn Caption="SF1" FieldName="SF1_SET_WEIGHT" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            Width="65px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="SF2" FieldName="SF2_SET_WEIGHT" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            Width="65px" VisibleIndex="1" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="SF3" FieldName="SF3_SET_WEIGHT" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            Width="65px" VisibleIndex="2" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="SF4" FieldName="SF4_SET_WEIGHT" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            Width="65px" VisibleIndex="3" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="SF5" FieldName="SF5_SET_WEIGHT" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            Width="65px" VisibleIndex="4" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="SF6" FieldName="SF6_SET_WEIGHT" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            Width="65px" VisibleIndex="5" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="总计" FieldName="SF_SUM" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                ...
                                                <dx:GridViewBandColumn Caption="球团矿(t)" VisibleIndex="8">
                                                    <Columns>
                                                        <dx:GridViewDataTextColumn Caption="AF1" FieldName="AF1_SET_WEIGHT" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            Width="65px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="AF2" FieldName="AF2_SET_WEIGHT" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            Width="65px" VisibleIndex="1" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="总计" FieldName="AF_SUM" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            Width="65px" VisibleIndex="2" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                        </dx:GridViewDataTextColumn>
                                                    </Columns>
                                                </dx:GridViewBandColumn>
                                                <dx:GridViewBandColumn Caption="块矿(t)" VisibleIndex="9">
                                                    <Columns>
                                                        <dx:GridViewDataTextColumn Caption="OF1" FieldName="OF1_SET_WEIGHT" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            Width="65px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="OF2" FieldName="OF2_SET_WEIGHT" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            Width="65px" VisibleIndex="1" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="总计" FieldName="OF_SUM" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            Width="65px" VisibleIndex="2" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                        </dx:GridViewDataTextColumn>
                                                    </Columns>
                                                </dx:GridViewBandColumn>
                                                <dx:GridViewBandColumn Caption="辅料(t)" VisibleIndex="10">
                                                    <Columns>
                                                        <dx:GridViewDataTextColumn Caption="ZF1" FieldName="ZF1_SET_WEIGHT" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            Width="65px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="ZF2" FieldName="ZF2_SET_WEIGHT" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            Width="65px" VisibleIndex="1" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="总计" FieldName="ZF_SUM" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            Width="65px" VisibleIndex="2" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                        </dx:GridViewDataTextColumn>
                                                    </Columns>
                                                </dx:GridViewBandColumn>
                                                <dx:GridViewBandColumn Caption="焦丁(t)" VisibleIndex="10">
                                                    <Columns>
                                                        <dx:GridViewDataTextColumn Caption="CFD" FieldName="CFD_SET_WEIGHT" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                            Width="65px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                        </dx:GridViewDataTextColumn>
                                                    </Columns>
                                                </dx:GridViewBandColumn>
                                                ...
                                                <dx:GridViewBandColumn Visible="false">
                                                    <Columns>
                                                        <dx:GridViewDataTextColumn Caption="" FieldName="MAT_SUM1" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            VisibleIndex="2" Visible="false">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="" FieldName="MAT_SUM2" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            VisibleIndex="2" Visible="false">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="" FieldName="SF1_SUM1" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            VisibleIndex="2" Visible="false">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="" FieldName="SF1_SUM2" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            VisibleIndex="2" Visible="false">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="" FieldName="SF2_SUM1" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            VisibleIndex="2" Visible="false">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="" FieldName="SF2_SUM2" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            VisibleIndex="2" Visible="false">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="" FieldName="SF3_SUM1" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            VisibleIndex="2" Visible="false">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="" FieldName="SF3_SUM2" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            VisibleIndex="2" Visible="false">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="" FieldName="SF4_SUM1" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            VisibleIndex="2" Visible="false">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="" FieldName="SF4_SUM2" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            VisibleIndex="2" Visible="false">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="" FieldName="SF5_SUM1" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            VisibleIndex="2" Visible="false">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="" FieldName="SF5_SUM2" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            VisibleIndex="2" Visible="false">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="" FieldName="SF6_SUM1" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            VisibleIndex="2" Visible="false">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="" FieldName="SF6_SUM2" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            VisibleIndex="2" Visible="false">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="" FieldName="SF_SUM1" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            VisibleIndex="2" Visible="false">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="" FieldName="SF_SUM2" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            VisibleIndex="2" Visible="false">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="" FieldName="AF1_SUM1" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            VisibleIndex="2" Visible="false">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="" FieldName="AF1_SUM2" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            VisibleIndex="2" Visible="false">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="" FieldName="AF2_SUM1" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            VisibleIndex="2" Visible="false">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="" FieldName="AF2_SUM2" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            VisibleIndex="2" Visible="false">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="" FieldName="AF_SUM1" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            VisibleIndex="2" Visible="false">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="" FieldName="AF_SUM2" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            VisibleIndex="2" Visible="false">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="" FieldName="OF1_SUM1" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            VisibleIndex="2" Visible="false">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="" FieldName="OF1_SUM2" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            VisibleIndex="2" Visible="false">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="" FieldName="OF2_SUM1" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            VisibleIndex="2" Visible="false">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="" FieldName="OF2_SUM2" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            VisibleIndex="2" Visible="false">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="" FieldName="OF_SUM1" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            VisibleIndex="2" Visible="false">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="" FieldName="OF_SUM2" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            VisibleIndex="2" Visible="false">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="" FieldName="ZF1_SUM1" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            VisibleIndex="2" Visible="false">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="" FieldName="ZF1_SUM2" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            VisibleIndex="2" Visible="false">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="" FieldName="ZF2_SUM1" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            VisibleIndex="2" Visible="false">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="" FieldName="ZF2_SUM2" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            VisibleIndex="2" Visible="false">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="" FieldName="ZF_SUM1" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            VisibleIndex="2" Visible="false">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="" FieldName="ZF_SUM2" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            VisibleIndex="2" Visible="false">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="" FieldName="CFD_SUM1" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            VisibleIndex="2" Visible="false">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="" FieldName="CFD_SUM2" Width="65px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                            VisibleIndex="2" Visible="false">
                                                        </dx:GridViewDataTextColumn>
                                                    </Columns>
                                                </dx:GridViewBandColumn>
                                            ...
                                            <TotalSummary>
                                                ...
                                                <dx:ASPxSummaryItem Tag="tag1" FieldName="CFD_SUM1" ShowInColumn="CFD_SET_WEIGHT" SummaryType="Sum" DisplayFormat="{0:0.00}"/>
                                                <dx:ASPxSummaryItem Tag="tag2" FieldName="CFD_SUM2" ShowInColumn="CFD_SET_WEIGHT" SummaryType="Sum" DisplayFormat="{0:0.00}"/>
                                            </TotalSummary>
                                            <GroupSummary>
                                                <dx:ASPxSummaryItem FieldName="RECORD_TIME" ShowInGroupFooterColumn="RECORD_TIME" SummaryType="Count" DisplayFormat="合计{0}条" />
                                                <dx:ASPxSummaryItem Tag="tag1" FieldName="DATA_TYPE" ShowInGroupFooterColumn="DATA_TYPE" SummaryType="Max" DisplayFormat="{0}" />
                                                ...
                                                <dx:ASPxSummaryItem Tag="tag1" FieldName="CFD_SUM1" ShowInGroupFooterColumn="CFD_SET_WEIGHT" SummaryType="Sum" DisplayFormat="{0:0.00}"/>
                                                <dx:ASPxSummaryItem Tag="tag2" FieldName="CFD_SUM2" ShowInGroupFooterColumn="CFD_SET_WEIGHT" SummaryType="Sum" DisplayFormat="{0:0.00}"/>
                                            </GroupSummary>
