<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BFlclw_Rep_1.aspx.cs" Inherits="BF_Report.Manager.Module.Report._1280BF.BFlclw_Rep_1" %>
        ...
        <div>
            <table style="width: 100%;">
                <tr style="background-color: cornflowerblue; font-size: 15pt;">
                    <td width="100%;" height="30px" align="center" valign="center">1#高炉料仓料位日报
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                                                ...
                                                <dx:PanelContent ID="PanelContent1" runat="server" SupportsDisabledAttribute="True">
                                                    <dx:ASPxGridView ID="gridBase1" runat="server" ClientInstanceName="gridBase1" Width="100%" Theme="Office2010Blue" OnHtmlRowPrepared="gridBase1_HtmlRowPrepared" Font-Size="14px">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dx:GridViewDataTextColumn Caption="焦丁仓" FieldName="焦丁仓" Width="45px" ShowInCustomizationForm="false" UnboundType="Decimal"
                                                                VisibleIndex="24" >                                                
                                                            </dx:GridViewDataTextColumn>                 
