<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProdDay_Rep_1.aspx.cs" Inherits="BF_Report.Manager.Module.Report._1280BF.ProdDay_Rep_1" %>
        ...
        <div>
            <table style="width: 100%;">
                <tr style="background-color: cornflowerblue; font-size: 15pt;">
                    <td width="100%;" height="30px" align="center" valign="center">1#高炉生产作业日报表
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                                ...
                                <td>
                                    <table style="width: 100%; height: 35px;" valign="center">
                                        <tr>
                                            ...
                                            <td width="100%">&nbsp;</td>
                                            <td width="100px">
                                                <dx:ASPxLabel ID="ASPxLabel4" runat="server" Text="R61-144/0-15-E" Width="100px">
                                                </dx:ASPxLabel>
                                            </td>
                                        </tr>
                                    </table>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="项目" >
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="时间" FieldName="field0" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="50px" VisibleIndex="1" name="aaa">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <dx:GridViewBandColumn ShowInCustomizationForm="True" Caption="下料情况" VisibleIndex="1">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn FieldName="field1" UnboundType="Decimal" ShowInCustomizationForm="True" Caption="料批" Width="50px" VisibleIndex="2"></dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn FieldName="field2" UnboundType="Decimal" ShowInCustomizationForm="True" Caption="累计" Width="50px" VisibleIndex="3"></dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <dx:GridViewBandColumn ShowInCustomizationForm="True" Caption="送风制度" VisibleIndex="2">
                                                                <Columns>
                                                                    <dx:GridViewBandColumn ShowInCustomizationForm="True" Caption="风量" VisibleIndex="1">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn FieldName="field3" UnboundType="Decimal" ShowInCustomizationForm="True" Caption="m³/min" Width="70px"
                                                                    ...
                                                                    <dx:GridViewBandColumn ShowInCustomizationForm="True" Caption="热风压" VisibleIndex="2">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn FieldName="field4" UnboundType="Decimal" ShowInCustomizationForm="True" Caption="kPa" Width="65px" VisibleIndex="5"></dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                                    <dx:GridViewBandColumn ShowInCustomizationForm="True" Caption="炉顶压" VisibleIndex="3">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn FieldName="field5" UnboundType="Decimal" ShowInCustomizationForm="True" Caption="kPa" Width="65px" VisibleIndex="6"></dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                                    <dx:GridViewBandColumn ShowInCustomizationForm="True" Caption="全压差" VisibleIndex="5">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn FieldName="field7" UnboundType="Decimal" ShowInCustomizationForm="True" Caption="kPa" Width="65px" VisibleIndex="7"></dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                                    <dx:GridViewDataTextColumn FieldName="field6" UnboundType="Decimal" ShowInCustomizationForm="True" Caption="透气性指数" Width="65px" VisibleIndex="4"></dx:GridViewDataTextColumn>
                                                                    <dx:GridViewBandColumn ShowInCustomizationForm="True" Caption="喷煤量" VisibleIndex="6">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn FieldName="field8" UnboundType="Decimal" ShowInCustomizationForm="True" Caption="t/h" Width="65px" VisibleIndex="9"></dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                                    <dx:GridViewBandColumn ShowInCustomizationForm="True" Caption="风温" VisibleIndex="7">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn FieldName="field9" UnboundType="Decimal" ShowInCustomizationForm="True" Caption="℃" Width="70px"
                                                                    ...
                                                                    <dx:GridViewBandColumn ShowInCustomizationForm="True" Caption="富氧量" VisibleIndex="8">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn FieldName="field10" UnboundType="Decimal" ShowInCustomizationForm="True" Caption="m³/h" Width="75px" VisibleIndex="11" PropertiesTextEdit-DisplayFormatString="{0:0}" />
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <dx:GridViewDataTextColumn FieldName="field11" UnboundType="Decimal" ShowInCustomizationForm="True" Caption="煤气利用率" Width="65px" VisibleIndex="3"></dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn FieldName="field12" UnboundType="Decimal" ShowInCustomizationForm="True" Caption="炉基温度℃" Width="65px" VisibleIndex="4"></dx:GridViewDataTextColumn>
                                                                ...
                                                                <Columns>
                                                                    <dx:GridViewBandColumn Caption="悬料、滑料、崩料，慢、休风">
                                                                        <Columns>
                                                                            ...
                                                                            <dx:GridViewDataTextColumn Caption="时间" FieldName="field19" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="55px" VisibleIndex="2">
                                                                            </dx:GridViewDataTextColumn>
