<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CostConsumeCX_Rep_1.aspx.cs" Inherits="BF_Report.Manager.Module.Report._1280BF.CostConsumeCX_Rep_1" %>
        ...
        <div>
            <table style="width: 100%;">
                <tr style="background-color: cornflowerblue; font-size: 15pt;">
                    <td width="100%;" height="30px" align="center" valign="center">1#高炉成本报表
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                                                    ...
                                                    <dx:ASPxGridView ID="gridBase1" runat="server" ClientInstanceName="gridBase1" Width="100%" Theme="Office2010Blue" OnHtmlRowPrepared="gridBase1_HtmlRowPrepared" Font-Size="10PX">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="本日产量(t):" Name="gbc1" VisibleIndex="1">
                                                                <Columns>
                                                                    <dx:GridViewBandColumn Caption="本日(槽下工艺称)" VisibleIndex="1">
                                                                        <Columns>
                                                                            ...
                                                                            <dx:GridViewDataTextColumn Caption="数量(干吨)" FieldName="DAY_TOTAL" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                                Width="70px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                                <CellStyle HorizontalAlign="Right"></CellStyle>
                                                                            </dx:GridViewDataTextColumn>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="本月产量(t):" Name="gbc2" VisibleIndex="2">
                                                                <Columns>
                                                                    <dx:GridViewBandColumn Caption="本月(槽上皮带秤平均)" VisibleIndex="1">
                                                                        <Columns>
                                                                             <dx:GridViewDataTextColumn Caption="湿吨" FieldName="MONTH_WET" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                                Width="70px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                                <CellStyle HorizontalAlign="Right"></CellStyle>
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="数量(干吨)" FieldName="MONTH_TOTAL" ShowInCustomizationForm="True" UnboundType="Decimal"
                                                                                Width="70px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                                <CellStyle HorizontalAlign="Right"></CellStyle>
                                                                            </dx:GridViewDataTextColumn>
