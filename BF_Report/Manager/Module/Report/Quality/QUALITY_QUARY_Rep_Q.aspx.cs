...
{
    public partial class QUALITY_QUARY_Rep_Q : System.Web.UI.Page
    {
        ...
        protected void cbp_Base_Callback(object sender, DevExpress.Web.CallbackEventArgsBase e)
       {
        ...
        public void select(DateTime Begin_time, DateTime End_time, string i)
        {
            ...
            OracleConnection con = new OracleConnection("User Id = ORALTL2_BF; Password=oraltl2_1500f;Data Source = (DESCRIPTION = (ADDRESS_LIST = (ADDRESS = (PROTOCOL = TCP)(HOST = 172.16.8.16)(PORT = 1521)))(CONNECT_DATA = (SERVICE_NAME = ORALTL2)))");
            con.Open();
