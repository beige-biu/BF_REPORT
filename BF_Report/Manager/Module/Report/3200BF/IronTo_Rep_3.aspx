<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IronTo_Rep_3.aspx.cs" Inherits="BF_Report.Manager.Module.Report._3200BF.IronTo_Rep_3" %>
        ...
        <div>
            <table style="width: 100%;">
                <tr style="background-color: cornflowerblue; font-size: 15pt;">
                    <td width="100%;" height="30px" align="center" valign="center">3#高炉铁水热装日报表
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                                                ...
                                                <dx:PanelContent ID="PanelContent1" runat="server" SupportsDisabledAttribute="True">
                                                    <dx:ASPxGridView ID="gridBase1" runat="server" ClientInstanceName="gridBase1" Width="100%" Theme="Office2010Blue" OnHtmlRowPrepared="gridBase1_HtmlRowPrepared" OnCustomCellMerge="gridBase1_CustomCellMerge" Font-Size="14px">
                                                        ...
                                                        <Columns>                                                            
                                                            ...
                                                            <dx:GridViewDataTextColumn Caption="出铁时间" FieldName="field1" Width="80px" ShowInCustomizationForm="false" UnboundType="String"
                                                                VisibleIndex="1">
                                                                <PropertiesTextEdit DisplayFormatString="yyyy-MM-dd HH:mm"></PropertiesTextEdit>
                                                                <Settings AllowCellMerge="True" />
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="炉号" FieldName="field2" Width="80px" ShowInCustomizationForm="false" UnboundType="String"
                                                                VisibleIndex="2" SortOrder="Ascending">
                                                                <Settings AllowCellMerge="True" />
                                                            </dx:GridViewDataTextColumn>
