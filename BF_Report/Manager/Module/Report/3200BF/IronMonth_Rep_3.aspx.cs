...
{
    public partial class IronMonth_Rep_3 : System.Web.UI.Page
    {
        ...
        protected void GetData()
        {
            try
            {
                ...
                strSQL += " where unit_no='5' and b.jdg_grade in ('L03', 'L04', 'L06', 'L10', '等外')  ";
                ...
                String SQL1 = "SELECT KT from T_INSERT_JSKT where unit_no='3' and record_time>to_char(to_date('" + strStartTime + "','yyyy-MM-dd hh24:mi:ss'),'yyyyMM') and record_time<=to_char(to_date('" + strEndTime + "','yyyy-MM-dd hh24:mi:ss'),'yyyyMM')";
