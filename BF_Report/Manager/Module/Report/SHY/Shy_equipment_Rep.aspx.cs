...
{
    public partial class Shy_equipment_Rep : System.Web.UI.Page
    {
        ...
        protected void GetData(string strHeight)
        {
            ...
            strSQL = "SELECT * FROM XCIRON.T_LIMEKM_SHEBEI  ";
            strSQL += "where D_DT between to_date('" + strStartTime + "', 'yyyy-mm-dd hh24:mi:ss') and to_date('" + strEndTime + "', 'yyyy-mm-dd hh24:mi:ss')  ";
            strSQL += "order by D_DT asc ";
