...
{
    public partial class Shypmzl_Rep : System.Web.UI.Page
    {
        ...
        protected void GetData(string strHeight)
        {
            ...
            string strSQL = "";
            strSQL = "SELECT SEND_TIME,DICT_NO,CASE  WP_NO WHEN 'SN' THEN '2号石灰窑' WHEN 'SH' THEN '1号石灰窑' END AS WP_NO, ";
            strSQL += "CLASS_KIND,SENDER,DICT_CONT,RECE_TIME,RECEIVER,REMARK ";
            strSQL += "FROM XCIRON.T_LIMEKM_PUFFSUPPLY ";
            strSQL += "WHERE SEND_TIME between to_date('" + strStartTime + "', 'yyyy-mm-dd hh24:mi:ss') and to_date('" + strEndTime + "', 'yyyy-mm-dd hh24:mi:ss') ";
            strSQL += "ORDER BY SEND_TIME DESC";
