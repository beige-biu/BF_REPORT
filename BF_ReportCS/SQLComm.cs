...
namespace BF_ReportCS
{
    public static class SQLComm
    {
        public static string strHeight;
        public static string connstr = @"Data Source=oraltl2;Persist Security Info=True;User ID=ORALTL2_BF;Password=oraltl2_1500f;Unicode=True";
