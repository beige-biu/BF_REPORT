<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Power_Rep.aspx.cs" Inherits="BF_ReportCS.Manager.Module.Report._1500BF.Power_Rep" %>
        ...
        <div>
            <table style="width: 100%;">
                <tr style="background-color: cornflowerblue; font-size: 15pt;">
                    <td width="100%;" height="30px" align="center" valign="center">能源日报表
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                                                    ...
                                                    <dx:ASPxGridView ID="gridBase1" runat="server" ClientInstanceName="gridBase1" Width="100%" Theme="Office2010Blue" OnHtmlRowPrepared="gridBase1_HtmlRowPrepared" Font-Size="14px">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="压缩空气(m³)" VisibleIndex="4">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="外线" FieldName="AIR_AMOUNT" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="80px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0}">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="1280支管" FieldName="BF1280_AIR_AMOUNT" ShowInCustomizationForm="True" UnboundType="String"
                                                            ...
                                                            <dx:GridViewBandColumn Caption="氧气(富氧)" VisibleIndex="6">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="m³" FieldName="N2_AMOUNT" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0}">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="蒸汽" VisibleIndex="8">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="m³" FieldName="STEAM_AMOUNT" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0}">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
