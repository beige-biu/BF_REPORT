            ...
            try
            {
                ...
                if (dt != null && dt.Rows.Count > 0)
                {
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        SQLComm.Prodt1.Rows[i]["OXY_AMOUNT"] = double.Parse(dt.Rows[i]["N2_AMOUNT"].ToString()).ToString("N0").Replace(",", ""); //高压富氧
                        SQLComm.Prodt1.Rows[i]["R_LG_ACTIVE"] = double.Parse(dt.Rows[i]["OXY_AMOUNT"].ToString()).ToString("N0").Replace(",", ""); //机前富氧
                        SQLComm.Prodt1.Rows[i]["field11"] = dt.Rows[i]["GAS_USE"].ToString(); //煤气利用率
                        SQLComm.Prodt1.Rows[i]["field12"] = dt.Rows[i]["T_LD_HEART"].ToString(); //炉基温度
                    ...
                    try
                    {
                        if (iCount1 > 12)
                        {
                            ...
                            SQLComm.Prodt1.Rows[iCount1]["field2"] = double.Parse(dt.Compute("sum(HOUR_CHARGE)", "").ToString()).ToString("N0").Replace(",", "");
                            ...
                            SQLComm.Prodt1.Rows[iCount1]["OXY_AMOUNT"] = double.Parse(dt.Compute("avg(N2_AMOUNT)", "").ToString()).ToString("N2").Replace(",", "");
                            SQLComm.Prodt1.Rows[iCount1]["R_LG_ACTIVE"] = double.Parse(dt.Compute("avg(OXY_AMOUNT)", "").ToString()).ToString("N2").Replace(",", "");
                            SQLComm.Prodt1.Rows[iCount1]["field11"] = double.Parse(dt.Compute("avg(GAS_USE)", "").ToString()).ToString("N2").Replace(",", "");
                            SQLComm.Prodt1.Rows[iCount1]["field12"] = double.Parse(dt.Compute("avg(T_LD_HEART)", "").ToString()).ToString("N2").Replace(",", "");
                        ...
                        else
                        {
                            ...
                            SQLComm.Prodt1.Rows[12]["field2"] = double.Parse(dt.Compute("sum(HOUR_CHARGE)", "").ToString()).ToString("N0").Replace(",", "");
                            ...
                            SQLComm.Prodt1.Rows[12]["OXY_AMOUNT"] = double.Parse(dt.Compute("avg(N2_AMOUNT)", "").ToString()).ToString("N2").Replace(",", "");
                            SQLComm.Prodt1.Rows[12]["R_LG_ACTIVE"] = double.Parse(dt.Compute("avg(OXY_AMOUNT)", "").ToString()).ToString("N2").Replace(",", "");
                            SQLComm.Prodt1.Rows[12]["field11"] = double.Parse(dt.Compute("avg(GAS_USE)", "").ToString()).ToString("N2").Replace(",", "");
                            SQLComm.Prodt1.Rows[12]["field12"] = double.Parse(dt.Compute("avg(T_LD_HEART)", "").ToString()).ToString("N2").Replace(",", "");
                ...
                if (dt != null && dt.Rows.Count > 0)
                {
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        double dIronTemp = 0;
                        SQLComm.Prodt1.Rows[i]["field13"] = dt.Rows[i]["IRON_NO"].ToString();//铁次
