...
namespace BF_ReportCS.Manager.Module.Report._1500BF
{
    public partial class BFRun_Rep_fal : System.Web.UI.Page
    {
        ...
        protected void GetData(string strHeight)
        {
            ...
            {
                strSQL = "select a.RECORD_TIME,a.WORK_SHIFT,a.WORK_TEAM,a.HOUR_CHARGE,a.GAS_USE,a.BLAST_AMOUNT as BLAST_AMOUNT,a.HOT_PRESS,COLD_PRESS, ";
                strSQL += "a.TOP_PRESS,a.BOTTOM_PRESS,a.TOP_PRESSDIFF,a.BOTTOM_PRESSDIFF,a.TOP_PRESSRATIO,a.MIDDLE_PRESSRATIO,  ";
                strSQL += "a.BOTTOM_PRESSRATIO,RTRIM(TO_CHAR((a.BLAST_AMOUNT) / a.P_ALL, 'FM9990.9'), '.') as TQX,BLAST_TEMP,a.TOP_TEMPMAX,a.TOP_TEMPMIN,a.TOP_TEMPAVG,RTRIM(TO_CHAR((0.55 * NVL((b.OXY_AMOUNT + b.N2_AMOUNT), 0) / (a.BLAST_AMOUNT) / 60 * 100), 'FM9990.9'), '.') AS RICH_OXY_RATIO,  ";
                ...
                strSQL += "NVL((b.OXY_AMOUNT + b.N2_AMOUNT), 0)*0.55 AS RICH_OXY_AMOUNT, NVL(b.OXY_AMOUNT, 0) AS R_LG_ACTIVE, NVL(b.N2_AMOUNT, 0) AS GY_OXY_AMOUNT, NVL(b.AVGPRE_MQ, 0) AS AVGPRE_MQ ";
            ...
            {
                strSQL = "select a.RECORD_TIME,a.WORK_SHIFT,a.WORK_TEAM,RTRIM(TO_CHAR(b.DAY_CHARGE,'FM9990.9'),'.') AS  HOUR_CHARGE ,a.GAS_USE,a.BLAST_AMOUNT as BLAST_AMOUNT,a.HOT_PRESS,COLD_PRESS, ";
                strSQL += "a.TOP_PRESS,a.BOTTOM_PRESS,a.TOP_PRESSDIFF,a.BOTTOM_PRESSDIFF,a.TOP_PRESSRATIO,a.MIDDLE_PRESSRATIO,  ";
                strSQL += "a.BOTTOM_PRESSRATIO,RTRIM(TO_CHAR((a.BLAST_AMOUNT) / a.P_ALL, 'FM9990.9'), '.') as TQX,BLAST_TEMP,a.TOP_TEMPMAX,a.TOP_TEMPMIN,a.TOP_TEMPAVG,RTRIM(TO_CHAR((0.55 * NVL((b.OXY_AMOUNT + b.N2_AMOUNT), 0) / (a.BLAST_AMOUNT) / 60 * 100), 'FM9990.9'), '.') AS RICH_OXY_RATIO,  ";
                strSQL += "a.COKE_JET,a.COKE_JET1,RTRIM(TO_CHAR(a.COKE_JET1*1000/158.3,'FM9990.9'),'.') AS COKE_RATIO,a.BLAST_SPEED,  ";
                strSQL += "a.ACT_SPEED,a.TH_BURN_TEMP,a.BLAST_ENERGY,a.P_ALL,a.TQX_T,a.TQX_B,a.GAS_AMOUNT,a.P_IND_WATER,a.XBG,a.P_SOFT1_WATER,  ";
