...
{
    public partial class IronMonth_Rep : System.Web.UI.Page
    {
        ...
        protected void GetData()
        {
            try
            {
                ...
                string strSQL = "";
                strSQL = " select a.NET_WEIGHT,a.DEST_GF,b.IRON_NO,b.JDG_GRADE from L2BF_COM.TMMIRF9_IO a left join ";
                strSQL += " (select a.IRON_NO, b.jdg_grade from T_IRON_MG a left join l2bf_com.tqmir24_io b on a.IRON_NO = substr(b.mat_sample_no, 0, 8)";
                strSQL += " where OUT_START_TIME between to_date('" + strStartTime + "', 'yyyy-mm-dd hh24:mi:ss') ";
                strSQL += " and to_date('" + strEndTime + "', 'yyyy-mm-dd hh24:mi:ss') and b.jdg_grade in ('L03', 'L04', 'L06', 'L10', '等外')";
                strSQL += " and substr(b.mat_sample_no,9,3)= 'L01'   and b.jdg_type = '1A1') b";
                strSQL += " on a.iron_degr = b.IRON_NO where IRON_NO is not null";
