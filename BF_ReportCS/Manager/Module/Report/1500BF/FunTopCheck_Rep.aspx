<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FunTopCheck_Rep.aspx.cs" Inherits="BF_ReportCS.Manager.Module.Report._1500BF.FunTopCheck_Rep" %>
        ...
        <div>
            <table style="width: 100%;">
                <tr style="background-color: cornflowerblue; font-size: 15pt;">
                    <td width="100%;" height="30px" align="center" valign="center">炉顶检测日报表
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                                                    ...
                                                    <dx:ASPxGridView ID="gridBase1" runat="server" ClientInstanceName="gridBase1" Width="100%" Theme="Office2010Blue" OnHtmlRowPrepared="gridBase1_HtmlRowPrepared" Font-Size="14px">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="蓄能器压力" VisibleIndex="3">
                                                                <Columns>
                                                                    <dx:GridViewBandColumn Caption="1#" VisibleIndex="0">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="A(kPa)" FieldName="PT_XNQ_1A" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="0">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="B(kPa)" FieldName="PT_XNQ_1B" ShowInCustomizationForm="True" UnboundType="String"
                                                                    ...
                                                                    <dx:GridViewBandColumn Caption="2#" VisibleIndex="0">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="A(kPa)" FieldName="PT_XNQ_2A" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="0">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="B(kPa)" FieldName="PT_XNQ_2B" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="1">
                                                                            </dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="齿轮箱温度" VisibleIndex="4" Visible="false" >
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="A" FieldName="TE202A" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="0">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="B" FieldName="TE202B" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="0">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="C1" FieldName="TE202C" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="0">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="C2" FieldName="TE202D" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="0">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <%--<dx:GridViewBandColumn Caption="除尘器" VisibleIndex="5">
                                                                <Columns>--%>
                                                                    <%--<dx:GridViewBandColumn Caption="出口煤气" VisibleIndex="0">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="流量" FieldName="FT1752" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="0">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="温度" FieldName="TE1752" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="1">
                                                                            </dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>--%>
                                                                    <%--<dx:GridViewBandColumn Caption="进口煤气" VisibleIndex="1">
                                                                        <Columns>--%>
                                                                            <dx:GridViewDataTextColumn Caption="除尘器进口煤气流量" FieldName="FT1751" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="75px" VisibleIndex="5">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <%--<dx:GridViewDataTextColumn Caption="温度" FieldName="TE1751" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="1">
                                                                            </dx:GridViewDataTextColumn>--%>
                                                                        <%--</Columns>
                                                                    </dx:GridViewBandColumn>--%>
                                                                    <%--<dx:GridViewBandColumn Caption="管道压力" VisibleIndex="2">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="进口" FieldName="PT1752" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="0">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="出口" FieldName="PT1753" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="1">
                                                                            </dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>--%>
                                                            ...
                                                            <%--<dx:GridViewDataTextColumn Caption="氮气罐压力" FieldName="PT1752" ShowInCustomizationForm="True" UnboundType="String"
                                                                Width="65px" VisibleIndex="6">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="氮气总管流量" FieldName="PT1752" ShowInCustomizationForm="True" UnboundType="String"
                                                                Width="65px" VisibleIndex="7">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="二次均压氮气管道压力" FieldName="PT1752" ShowInCustomizationForm="True" UnboundType="String"
                                                                Width="65px" VisibleIndex="8">
                                                            </dx:GridViewDataTextColumn>--%>
                                                            <dx:GridViewBandColumn Caption="阀箱温度" VisibleIndex="9" Visible="false">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="1" FieldName="TE201A" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="0">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="2" FieldName="TE201B" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <%--<dx:GridViewBandColumn Caption="高炉旋风除尘动力配电箱温度" VisibleIndex="10">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="1" FieldName="TIAS1902" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="0">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="2" FieldName="TIAS1903" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="3" FieldName="TIAS1904" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="2">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="4" FieldName="TIAS1905" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="3">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>--%>
                                                            <dx:GridViewDataTextColumn Caption="进氮气罐前氮气管道压力" FieldName="PT1701" ShowInCustomizationForm="True" UnboundType="String"
                                                                Width="65px" VisibleIndex="11">
                                                            </dx:GridViewDataTextColumn>
                                                           <%-- <dx:GridViewBandColumn Caption="进气密箱氮气管道" VisibleIndex="12">
                                                                <Columns>--%>
                                                                    <dx:GridViewDataTextColumn Caption="进气密箱氮气管道压力" FieldName="PT1704" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="12">
                                                                    </dx:GridViewDataTextColumn>
                                                                   <%-- <dx:GridViewDataTextColumn Caption="流量" FieldName="FT1704" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>--%>
                                                                <%--</Columns>
                                                            </dx:GridViewBandColumn>--%>
                                                            <dx:GridViewBandColumn Caption="均压管道" VisibleIndex="13">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="温度" FieldName="TE1707" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="0">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="温度B" FieldName="TE1705B" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="压力A" FieldName="PT1705A" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="2">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <%--<dx:GridViewDataTextColumn Caption="新增料罐压力" FieldName="PT1705B" ShowInCustomizationForm="True" UnboundType="String"
                                                            ...
                                                            <dx:GridViewBandColumn Caption="均压用" VisibleIndex="15">
                                                                <Columns>
                                                                    <dx:GridViewBandColumn Caption="氮气总管" VisibleIndex="0">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="流量" FieldName="FT1703" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="0">
                                                                            </dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                                    <dx:GridViewBandColumn Caption="煤气管" VisibleIndex="1">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="流量" FieldName="FT1707" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="75px" VisibleIndex="0">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="温度" FieldName="PT1707" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="1">
                                                                            </dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                            ...
                                                            <dx:GridViewDataTextColumn Caption="冷却水进水管道压力" FieldName="PT1711" ShowInCustomizationForm="True" UnboundType="String"
                                                                Width="65px" VisibleIndex="16">
                                                            </dx:GridViewDataTextColumn>
                                                            <%--<dx:GridViewBandColumn Caption="料罐" VisibleIndex="17">
                                                                <Columns>--%>
                                                                    <dx:GridViewDataTextColumn Caption="料罐称重" FieldName="WIT1701" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="17">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <%--<dx:GridViewDataTextColumn Caption="料位" FieldName="LT1703" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="2">
                                                                    </dx:GridViewDataTextColumn>--%>
                                                                <%--</Columns>
                                                            </dx:GridViewBandColumn>--%>
                                                            <dx:GridViewBandColumn Caption="溜槽倾动电机温度" VisibleIndex="18" Visible="false">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="1" FieldName="TE_LCQD_1" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="2" FieldName="TE_LCQD_2" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="2">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="3" FieldName="TE_LCQD_3" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="3">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <dx:GridViewBandColumn Caption="溜槽旋转电机温度" VisibleIndex="19" Visible="false">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="1" FieldName="TE_LCXZ_1" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="2" FieldName="TE_LCXZ_2" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="2">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="3" FieldName="TE_LCXZ_3" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="3">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <dx:GridViewDataTextColumn Caption="炉顶蒸汽管道温度" FieldName="TE1706" ShowInCustomizationForm="True" UnboundType="String"
                                                                Width="65px" VisibleIndex="20">
                                                            </dx:GridViewDataTextColumn>
                                                            <%--<dx:GridViewDataTextColumn Caption="煤气下降管温度" FieldName="TE1901" ShowInCustomizationForm="True" UnboundType="String"
                                                                Width="65px" VisibleIndex="21">
                                                            </dx:GridViewDataTextColumn>--%>
                                                            <dx:GridViewBandColumn Caption="气密箱冷却水" VisibleIndex="22">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="回水管温度" FieldName="TE1712" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="进水管流量" FieldName="FT1711" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="2">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="进水管温度" FieldName="TE1711" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="3">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="前氮气管道阀位反馈" FieldName="PV1704" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="4">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <dx:GridViewDataTextColumn Caption="受料罐料位" FieldName="LT1702" ShowInCustomizationForm="True" UnboundType="String"
                                                                Width="70px" VisibleIndex="23">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewBandColumn Caption="上密阀温度" VisibleIndex="24" Visible="false">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="1" FieldName="TE108A" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="2" FieldName="TE108B" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="2">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                           <%-- <dx:GridViewBandColumn Caption="下密阀" VisibleIndex="25">
                                                                <Columns>--%>
                                                                    <dx:GridViewDataTextColumn Caption="下密阀温度" FieldName="TE110A" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="25">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <%--<dx:GridViewDataTextColumn Caption="2" FieldName="TE110B" ShowInCustomizationForm="True" UnboundType="String"
                                                            ...
                                                            <dx:GridViewBandColumn Caption="液压站" VisibleIndex="26">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="油位" FieldName="LT_YYZ" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="温度" FieldName="TE_YYZ_OIL" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="2">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <dx:GridViewBandColumn Caption="油站压力" VisibleIndex="27">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="P1口" FieldName="PT_YZ_P1" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="P2口" FieldName="PT_YZ_P2" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="2">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <%--<dx:GridViewDataTextColumn Caption="蒸汽管道压力" FieldName="PT1706" ShowInCustomizationForm="True" UnboundType="String"
                                                                Width="65px" VisibleIndex="28">
                                                            </dx:GridViewDataTextColumn>--%>
                                                            <%--<dx:GridViewBandColumn Caption="中间灰罐" VisibleIndex="29">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="A" FieldName="WIT1906" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="B" FieldName="WIT1907" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="2">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>--%>
                                                            <dx:GridViewBandColumn Caption="炉顶煤气" VisibleIndex="30">
                                                                <Columns>
                                                                    ...
                                                                    <dx:GridViewBandColumn Caption="煤气利用率" VisibleIndex="1">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="%" FieldName="GAS_UE" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="1">
                                                                            </dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
