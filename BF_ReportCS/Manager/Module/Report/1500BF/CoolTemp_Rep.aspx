<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CoolTemp_Rep.aspx.cs" Inherits="BF_ReportCS.Manager.Module.Report._1500BF.CoolTemp_Rep" %>
        ...
        <div>
            <table style="width: 100%;">
                <tr style="background-color: cornflowerblue; font-size: 15pt;">
                    <td width="100%;" height="30px" align="center" valign="center">冷却壁测温日报表
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                                                            ...
                                                            <dx:GridViewBandColumn Caption="XX温度" VisibleIndex="3" Name="gbc13">
                                                                <Columns>
                                                                    ...
                                                                    <dx:GridViewBandColumn Caption="2" VisibleIndex="0" Name="gbc15">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="℃" FieldName="FIELD_11" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="0">
                                                                            </dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                                    <dx:GridViewBandColumn Caption="3" VisibleIndex="0" Name="gbc16">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="℃" FieldName="FIELD_12" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="0">
                                                                            </dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                                    <dx:GridViewBandColumn Caption="4" VisibleIndex="0" Name="gbc17">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="℃" FieldName="FIELD_13" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="0">
                                                                            </dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                                    <dx:GridViewBandColumn Caption="5" VisibleIndex="0" Name="gbc18">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="℃" FieldName="FIELD_14" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="0">
                                                                            </dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                                    <dx:GridViewBandColumn Caption="6" VisibleIndex="0" Name="gbc19">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="℃" FieldName="FIELD_15" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="0">
                                                                            </dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                                    <dx:GridViewBandColumn Caption="7" VisibleIndex="0" Name="gbc20">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="℃" FieldName="FIELD_16" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="0">
                                                                            </dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                                    <dx:GridViewBandColumn Caption="8" VisibleIndex="0" Name="gbc21">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="℃" FieldName="FIELD_17" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="0">
                                                                            </dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                                    <dx:GridViewBandColumn Caption="9" VisibleIndex="0" Name="gbc22">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="℃" FieldName="FIELD_18" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="0">
                                                                            </dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                                    <dx:GridViewBandColumn Caption="10" VisibleIndex="0" Name="gbc23">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="℃" FieldName="FIELD_19" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="0">
                                                                            </dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                                    <dx:GridViewBandColumn Caption="11" VisibleIndex="0" Name="gbc24">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="℃" FieldName="FIELD_20" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="0">
                                                                            </dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                                    <dx:GridViewBandColumn Caption="12" VisibleIndex="0" Name="gbc25">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="℃" FieldName="FIELD_21" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="0">
                                                                            </dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
