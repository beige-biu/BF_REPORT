<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BFRun_Rep.aspx.cs" Inherits="BF_ReportCS.Manager.Module.Report._1500BF.BFRun_Rep" %>
                                                    ...
                                                    <dx:ASPxGridView ID="gridBase1" runat="server" ClientInstanceName="gridBase1" Width="100%" Theme="Office2010Blue" OnHtmlRowPrepared="gridBase1_HtmlRowPrepared" Font-Size="14px">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <%--<dx:GridViewBandColumn Caption="软水供水总管" VisibleIndex="29">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="流量" FieldName="F_SOFT_WATER" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="70px" VisibleIndex="0">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="温度" FieldName="T_SOFT_WATER" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="70px" VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>--%>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="均压煤气回收量" VisibleIndex="36">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="m³" FieldName="AVGPRE_MQ" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="70px" VisibleIndex="0">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
