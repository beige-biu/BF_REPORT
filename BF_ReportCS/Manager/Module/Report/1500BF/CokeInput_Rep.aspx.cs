...
namespace BF_ReportCS.Manager.Module.Report._1500BF
{
    public partial class CokeInput_Rep : System.Web.UI.Page
    {
        ...
        protected void GetData(string strHeight)
        {
            ...
            strSQL += " from T_RPT_COKE_CONSUME  WHERE RECORD_TIME BETWEEN TO_DATE('" + strStartTime;
            strSQL += "','yyyy-mm-dd hh24:mi:ss') AND TO_DATE('" + strEndTime + "','yyyy-mm-dd hh24:mi:ss') ORDER BY RECORD_TIME ASC";
