...
namespace BF_ReportCS.Manager.Module.Report._1500BF
{
    public partial class OreInput_Rep : System.Web.UI.Page
    {
        ...
        protected void GetData(string strHeight)
        {
            ...
            string strSQL = "";
            strSQL = "select RECORD_TIME,WORK_SHIFT,WORK_TEAM,ORE_NAME,CHARGE_NO,BATCH_NO,'理论值' as DATA_TYPE，0 as MAT_SUM，SF1_SET_WEIGHT,";
            strSQL += "SF2_SET_WEIGHT,SF3_SET_WEIGHT,SF4_SET_WEIGHT,SF5_SET_WEIGHT,SF6_SET_WEIGHT,SF7_SET_WEIGHT,SF8_SET_WEIGHT,";
            strSQL += "SF9_SET_WEIGHT,SF10_SET_WEIGHT,0 as SF_SUM,AF1_SET_WEIGHT,AF2_SET_WEIGHT,0 as AF_SUM,OF1_SET_WEIGHT,";
            strSQL += "OF2_SET_WEIGHT,0 as OF_SUM,ZF1_SET_WEIGHT,ZF2_SET_WEIGHT,0 as ZF_SUM,CFD1_SET_WEIGHT,CFD2_SET_WEIGHT,";
            strSQL += "0 as CFD_SUM,CHARGE_ORE_FLAG, ";
            strSQL += "0 as MAT_SUM1,0 as SF1_SUM1,0 as SF2_SUM1,0 as SF3_SUM1,0 as SF4_SUM1,0 as SF5_SUM1,0 as SF6_SUM1,0 as SF7_SUM1,0 as SF8_SUM1,0 as SF9_SUM1,0 as SF10_SUM1,0 as SF_SUM1, ";
            strSQL += "0 as AF1_SUM1,0 as AF2_SUM1,0 as AF_SUM1,0 as OF1_SUM1,0 as OF2_SUM1,0 as OF_SUM1,0 as ZF1_SUM1,0 as ZF2_SUM1,0 as ZF_SUM1,0 as CFD1_SUM1,0 as CFD2_SUM1,0 as CFD_SUM1, ";
            strSQL += "0 as MAT_SUM2,SF1_SET_WEIGHT as SF1_SUM2,SF2_SET_WEIGHT as SF2_SUM2,SF3_SET_WEIGHT as SF3_SUM2,SF4_SET_WEIGHT as SF4_SUM2,SF5_SET_WEIGHT as SF5_SUM2,SF6_SET_WEIGHT as SF6_SUM2,SF7_SET_WEIGHT as SF7_SUM2,SF8_SET_WEIGHT as SF8_SUM2,SF9_SET_WEIGHT as SF9_SUM2,SF10_SET_WEIGHT as SF10_SUM2,0 as SF_SUM2,";
            strSQL += "AF1_SET_WEIGHT as AF1_SUM2,AF2_SET_WEIGHT as AF2_SUM2,0 as AF_SUM2,OF1_SET_WEIGHT as OF1_SUM2,OF2_SET_WEIGHT as OF2_SUM2,0 as OF_SUM2,ZF1_SET_WEIGHT as ZF1_SUM2,ZF2_SET_WEIGHT as ZF2_SUM2,0 as ZF_SUM2,CFD1_SET_WEIGHT as CFD1_SUM2,CFD2_SET_WEIGHT as CFD2_SUM2,0 as CFD_SUM2";
            strSQL += " from T_RPT_ORE_CONSUME where RECORD_TIME between to_date('" + strStartTime + "', 'yyyy-mm-dd hh24:mi:ss') and to_date('" + strEndTime + "', 'yyyy-mm-dd hh24:mi:ss') order by RECORD_TIME asc";
            ...
            foreach (DataRow dr in dt1.Rows)
            {
                try
                {
                    ...
                    dsf += double.Parse(dr["SF7_SET_WEIGHT"].ToString()) + double.Parse(dr["SF8_SET_WEIGHT"].ToString()) + double.Parse(dr["SF9_SET_WEIGHT"].ToString());
                    dsf += double.Parse(dr["SF10_SET_WEIGHT"].ToString());
                    dr["SF_SUM"] = dsf.ToString("N2");
                    dr["SF_SUM2"] = dsf.ToString("N2");

                    double daf = double.Parse(dr["ZF1_SET_WEIGHT"].ToString()) + double.Parse(dr["AF1_SET_WEIGHT"].ToString()) + double.Parse(dr["AF2_SET_WEIGHT"].ToString());
                    ...
                    double dzf =  double.Parse(dr["ZF2_SET_WEIGHT"].ToString());
                    dr["ZF_SUM"] = dzf.ToString("N2");
                    dr["ZF_SUM2"] = dzf.ToString("N2");

                    double dcfd = double.Parse(dr["CFD1_SET_WEIGHT"].ToString()) + double.Parse(dr["CFD2_SET_WEIGHT"].ToString());
                    dr["CFD_SUM"] = dcfd.ToString("N2");
                    dr["CFD_SUM2"] = dcfd.ToString("N2");
            ...
            strSQL = "select RECORD_TIME,WORK_SHIFT,WORK_TEAM,ORE_NAME,CHARGE_NO,BATCH_NO,'实际值' as DATA_TYPE，0 as MAT_SUM，SF1_ACT_WEIGHT as SF1_SET_WEIGHT,";
            strSQL += "SF2_ACT_WEIGHT as SF2_SET_WEIGHT,SF3_ACT_WEIGHT as SF3_SET_WEIGHT,SF4_ACT_WEIGHT as SF4_SET_WEIGHT,";
            strSQL += "SF5_ACT_WEIGHT as SF5_SET_WEIGHT,SF6_ACT_WEIGHT as SF6_SET_WEIGHT,SF7_ACT_WEIGHT as SF7_SET_WEIGHT,";
            strSQL += "SF8_ACT_WEIGHT as SF8_SET_WEIGHT,SF9_ACT_WEIGHT as SF9_SET_WEIGHT,SF10_ACT_WEIGHT as SF10_SET_WEIGHT,0 as SF_SUM,";
            ...
            strSQL += "CFD1_ACT_WEIGHT as CFD1_SET_WEIGHT,CFD2_ACT_WEIGHT as CFD2_SET_WEIGHT,";
            strSQL += "0 as CFD_SUM,CHARGE_ORE_FLAG, ";
            strSQL += "0 as MAT_SUM1,SF1_ACT_WEIGHT as SF1_SUM1,SF2_ACT_WEIGHT as SF2_SUM1,SF3_ACT_WEIGHT as SF3_SUM1,SF4_ACT_WEIGHT as SF4_SUM1,SF5_ACT_WEIGHT as SF5_SUM1,SF6_ACT_WEIGHT as SF6_SUM1,SF7_ACT_WEIGHT as SF7_SUM1,SF8_ACT_WEIGHT as SF8_SUM1,SF9_ACT_WEIGHT as SF9_SUM1,SF10_ACT_WEIGHT as SF10_SUM1,0 as SF_SUM1,";
            strSQL += "AF1_ACT_WEIGHT as AF1_SUM1,AF2_ACT_WEIGHT as AF2_SUM1,0 as AF_SUM1,OF1_ACT_WEIGHT as OF1_SUM1,OF2_ACT_WEIGHT as OF2_SUM1,0 as OF_SUM1,ZF1_ACT_WEIGHT as ZF1_SUM1,ZF2_ACT_WEIGHT as ZF2_SUM1,0 as ZF_SUM1,CFD1_ACT_WEIGHT as CFD1_SUM1,CFD2_ACT_WEIGHT as CFD2_SUM1,0 as CFD_SUM1,";
            strSQL += "0 as MAT_SUM2,0 as SF1_SUM2,0 as SF2_SUM2,0 as SF3_SUM2,0 as SF4_SUM2,0 as SF5_SUM2,0 as SF6_SUM2,0 as SF7_SUM2,0 as SF8_SUM2,0 as SF9_SUM2,0 as SF10_SUM2,0 as SF_SUM2,";
            strSQL += "0 as AF1_SUM2,0 as AF2_SUM2,0 as AF_SUM2,0 as OF1_SUM2,0 as OF2_SUM2,0 as OF_SUM2,0 as ZF1_SUM2,0 as ZF2_SUM2,0 as ZF_SUM2,0 as CFD1_SUM2,0 as CFD2_SUM2,0 as CFD_SUM2";
            strSQL += " from T_RPT_ORE_CONSUME where RECORD_TIME between to_date('" + strStartTime + "', 'yyyy-mm-dd hh24:mi:ss') and to_date('" + strEndTime + "', 'yyyy-mm-dd hh24:mi:ss') order by RECORD_TIME asc";
        ...
        protected void btnExp_Excel_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                for (int i = 1; i <= 2; i++)
                {
                    dt.Columns.Remove("CFD" + i + "_SUM1");
                    dt.Columns.Remove("CFD" + i + "_SUM2");
                }
                dt.Columns.Remove("CFD_SUM1");
                dt.Columns.Remove("CFD_SUM2");

                dt.Columns.Remove("CHARGE_ORE_FLAG");
                dt.Columns.Remove("CHARGE_NO");
                ...
                string file = Server.HtmlEncode(Request.PhysicalApplicationPath) + "Manager\\Module\\COMFILE\\矿石投料.xls";
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    sheet.Cells[index, 3].Value = dt.Rows[i]["BATCH_NO"].ToString();
                    ...
                    sheet.Cells[index, 12].Value = dt.Rows[i]["SF7_SET_WEIGHT"].ToString();
                    sheet.Cells[index, 12].Style = tmpStyle;

                    sheet.Cells[index, 13].Value = dt.Rows[i]["SF8_SET_WEIGHT"].ToString();
                    sheet.Cells[index, 13].Style = tmpStyle;

                    sheet.Cells[index, 14].Value = dt.Rows[i]["SF9_SET_WEIGHT"].ToString();
                    sheet.Cells[index, 14].Style = tmpStyle;

                    sheet.Cells[index, 15].Value = dt.Rows[i]["SF10_SET_WEIGHT"].ToString();
                    sheet.Cells[index, 15].Style = tmpStyle;

                    sheet.Cells[index, 16].Value = dt.Rows[i]["SF_SUM"].ToString();
                    sheet.Cells[index, 16].Style = tmpStyle;

                    sheet.Cells[index, 17].Value = dt.Rows[i]["AF1_SET_WEIGHT"].ToString();
                    sheet.Cells[index, 17].Style = tmpStyle;

                    sheet.Cells[index, 18].Value = dt.Rows[i]["AF2_SET_WEIGHT"].ToString();
                    sheet.Cells[index, 18].Style = tmpStyle;

                    sheet.Cells[index, 19].Value = dt.Rows[i]["AF_SUM"].ToString();
                    sheet.Cells[index, 19].Style = tmpStyle;

                    sheet.Cells[index, 20].Value = dt.Rows[i]["OF1_SET_WEIGHT"].ToString();
                    sheet.Cells[index, 20].Style = tmpStyle;

                    sheet.Cells[index, 21].Value = dt.Rows[i]["OF2_SET_WEIGHT"].ToString();
                    sheet.Cells[index, 21].Style = tmpStyle;

                    sheet.Cells[index, 22].Value = dt.Rows[i]["OF_SUM"].ToString();
                    sheet.Cells[index, 22].Style = tmpStyle;

                    sheet.Cells[index, 23].Value = dt.Rows[i]["ZF1_SET_WEIGHT"].ToString();
                    sheet.Cells[index, 23].Style = tmpStyle;

                    sheet.Cells[index, 24].Value = dt.Rows[i]["ZF2_SET_WEIGHT"].ToString();
                    sheet.Cells[index, 24].Style = tmpStyle;

                    sheet.Cells[index, 25].Value = dt.Rows[i]["ZF_SUM"].ToString();
                    sheet.Cells[index, 25].Style = tmpStyle;

                    sheet.Cells[index, 26].Value = dt.Rows[i]["CFD1_SET_WEIGHT"].ToString();
                    sheet.Cells[index, 26].Style = tmpStyle;

                    sheet.Cells[index, 27].Value = dt.Rows[i]["CFD2_SET_WEIGHT"].ToString();
                    sheet.Cells[index, 27].Style = tmpStyle;

                    sheet.Cells[index, 28].Value = dt.Rows[i]["CFD_SUM"].ToString();
                    sheet.Cells[index, 28].Style = tmpStyle;
                    ...
                    if (!string.IsNullOrEmpty(strShiftNext) && !strShiftNext.Equals(strShiftNow))
                    {
                        ...
                        strValue = dt.Compute("SUM(MAT_SUM)", "DATA_TYPE='" + strType1 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                        sheet.Cells[index, 5].Value = strValue;
                        sheet.Cells[index, 5].Style = tmpStyle;

                        strValue = dt.Compute("SUM(SF1_SET_WEIGHT)", "DATA_TYPE='" + strType1 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                        sheet.Cells[index, 6].Value = strValue;
                        sheet.Cells[index, 6].Style = tmpStyle;

                        strValue = dt.Compute("SUM(SF2_SET_WEIGHT)", "DATA_TYPE='" + strType1 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                        sheet.Cells[index, 7].Value = strValue;
                        sheet.Cells[index, 7].Style = tmpStyle;

                        strValue = dt.Compute("SUM(SF3_SET_WEIGHT)", "DATA_TYPE='" + strType1 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                        sheet.Cells[index, 8].Value = strValue;
                        sheet.Cells[index, 8].Style = tmpStyle;

                        strValue = dt.Compute("SUM(SF4_SET_WEIGHT)", "DATA_TYPE='" + strType1 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                        sheet.Cells[index, 9].Value = strValue;
                        sheet.Cells[index, 9].Style = tmpStyle;

                        strValue = dt.Compute("SUM(SF5_SET_WEIGHT)", "DATA_TYPE='" + strType1 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                        sheet.Cells[index, 10].Value = strValue;
                        sheet.Cells[index, 10].Style = tmpStyle;

                        strValue = dt.Compute("SUM(SF6_SET_WEIGHT)", "DATA_TYPE='" + strType1 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                        sheet.Cells[index, 11].Value = strValue;
                        sheet.Cells[index, 11].Style = tmpStyle;

                        strValue = dt.Compute("SUM(SF7_SET_WEIGHT)", "DATA_TYPE='" + strType1 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                        sheet.Cells[index, 12].Value = strValue;
                        sheet.Cells[index, 12].Style = tmpStyle;

                        strValue = dt.Compute("SUM(SF8_SET_WEIGHT)", "DATA_TYPE='" + strType1 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                        sheet.Cells[index, 13].Value = strValue;
                        sheet.Cells[index, 13].Style = tmpStyle;

                        strValue = dt.Compute("SUM(SF9_SET_WEIGHT)", "DATA_TYPE='" + strType1 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                        sheet.Cells[index, 14].Value = strValue;
                        sheet.Cells[index, 14].Style = tmpStyle;

                        strValue = dt.Compute("SUM(SF10_SET_WEIGHT)", "DATA_TYPE='" + strType1 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                        sheet.Cells[index, 15].Value = strValue;
                        sheet.Cells[index, 15].Style = tmpStyle;

                        strValue = dt.Compute("SUM(SF_SUM)", "DATA_TYPE='" + strType1 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                        sheet.Cells[index, 16].Value = strValue;
                        sheet.Cells[index, 16].Style = tmpStyle;

                        strValue = dt.Compute("SUM(AF1_SET_WEIGHT)", "DATA_TYPE='" + strType1 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                        sheet.Cells[index, 17].Value = strValue;
                        sheet.Cells[index, 17].Style = tmpStyle;

                        strValue = dt.Compute("SUM(AF2_SET_WEIGHT)", "DATA_TYPE='" + strType1 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                        sheet.Cells[index, 18].Value = strValue;
                        sheet.Cells[index, 18].Style = tmpStyle;

                        strValue = dt.Compute("SUM(AF_SUM)", "DATA_TYPE='" + strType1 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                        sheet.Cells[index, 19].Value = strValue;
                        sheet.Cells[index, 19].Style = tmpStyle;

                        strValue = dt.Compute("SUM(OF1_SET_WEIGHT)", "DATA_TYPE='" + strType1 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                        sheet.Cells[index, 20].Value = strValue;
                        sheet.Cells[index, 20].Style = tmpStyle;

                        strValue = dt.Compute("SUM(OF2_SET_WEIGHT)", "DATA_TYPE='" + strType1 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                        sheet.Cells[index, 21].Value = strValue;
                        sheet.Cells[index, 21].Style = tmpStyle;

                        strValue = dt.Compute("SUM(OF_SUM)", "DATA_TYPE='" + strType1 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                        sheet.Cells[index, 22].Value = strValue;
                        sheet.Cells[index, 22].Style = tmpStyle;

                        strValue = dt.Compute("SUM(ZF1_SET_WEIGHT)", "DATA_TYPE='" + strType1 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                        sheet.Cells[index, 23].Value = strValue;
                        sheet.Cells[index, 23].Style = tmpStyle;

                        strValue = dt.Compute("SUM(ZF2_SET_WEIGHT)", "DATA_TYPE='" + strType1 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                        sheet.Cells[index, 24].Value = strValue;
                        sheet.Cells[index, 24].Style = tmpStyle;

                        strValue = dt.Compute("SUM(ZF_SUM)", "DATA_TYPE='" + strType1 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                        sheet.Cells[index, 25].Value = strValue;
                        sheet.Cells[index, 25].Style = tmpStyle;

                        strValue = dt.Compute("SUM(CFD1_SET_WEIGHT)", "DATA_TYPE='" + strType1 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                        sheet.Cells[index, 26].Value = strValue;
                        sheet.Cells[index, 26].Style = tmpStyle;

                        strValue = dt.Compute("SUM(CFD2_SET_WEIGHT)", "DATA_TYPE='" + strType1 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                        sheet.Cells[index, 27].Value = strValue;
                        sheet.Cells[index, 27].Style = tmpStyle;

                        strValue = dt.Compute("SUM(CFD_SUM)", "DATA_TYPE='" + strType1 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                        sheet.Cells[index, 28].Value = strValue;
                        sheet.Cells[index, 28].Style = tmpStyle;
                        ...
                        if (!string.IsNullOrEmpty(strType2))
                        {
                            ...
                            strValue = dt.Compute("SUM(MAT_SUM)", "DATA_TYPE='" + strType2 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                            sheet.Cells[index, 5].Value = strValue;
                            sheet.Cells[index, 5].Style = tmpStyle;

                            strValue = dt.Compute("SUM(SF1_SET_WEIGHT)", "DATA_TYPE='" + strType2 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                            sheet.Cells[index, 6].Value = strValue;
                            sheet.Cells[index, 6].Style = tmpStyle;

                            strValue = dt.Compute("SUM(SF2_SET_WEIGHT)", "DATA_TYPE='" + strType2 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                            sheet.Cells[index, 7].Value = strValue;
                            sheet.Cells[index, 7].Style = tmpStyle;

                            strValue = dt.Compute("SUM(SF3_SET_WEIGHT)", "DATA_TYPE='" + strType2 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                            sheet.Cells[index, 8].Value = strValue;
                            sheet.Cells[index, 8].Style = tmpStyle;

                            strValue = dt.Compute("SUM(SF4_SET_WEIGHT)", "DATA_TYPE='" + strType2 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                            sheet.Cells[index, 9].Value = strValue;
                            sheet.Cells[index, 9].Style = tmpStyle;

                            strValue = dt.Compute("SUM(SF5_SET_WEIGHT)", "DATA_TYPE='" + strType2 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                            sheet.Cells[index, 10].Value = strValue;
                            sheet.Cells[index, 10].Style = tmpStyle;

                            strValue = dt.Compute("SUM(SF6_SET_WEIGHT)", "DATA_TYPE='" + strType2 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                            sheet.Cells[index, 11].Value = strValue;
                            sheet.Cells[index, 11].Style = tmpStyle;

                            strValue = dt.Compute("SUM(SF7_SET_WEIGHT)", "DATA_TYPE='" + strType2 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                            sheet.Cells[index, 12].Value = strValue;
                            sheet.Cells[index, 12].Style = tmpStyle;

                            strValue = dt.Compute("SUM(SF8_SET_WEIGHT)", "DATA_TYPE='" + strType2 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                            sheet.Cells[index, 13].Value = strValue;
                            sheet.Cells[index, 13].Style = tmpStyle;

                            strValue = dt.Compute("SUM(SF9_SET_WEIGHT)", "DATA_TYPE='" + strType2 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                            sheet.Cells[index, 14].Value = strValue;
                            sheet.Cells[index, 14].Style = tmpStyle;

                            strValue = dt.Compute("SUM(SF10_SET_WEIGHT)", "DATA_TYPE='" + strType2 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                            sheet.Cells[index, 15].Value = strValue;
                            sheet.Cells[index, 15].Style = tmpStyle;

                            strValue = dt.Compute("SUM(SF_SUM)", "DATA_TYPE='" + strType2 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                            sheet.Cells[index, 16].Value = strValue;
                            sheet.Cells[index, 16].Style = tmpStyle;

                            strValue = dt.Compute("SUM(AF1_SET_WEIGHT)", "DATA_TYPE='" + strType2 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                            sheet.Cells[index, 17].Value = strValue;
                            sheet.Cells[index, 17].Style = tmpStyle;

                            strValue = dt.Compute("SUM(AF2_SET_WEIGHT)", "DATA_TYPE='" + strType2 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                            sheet.Cells[index, 18].Value = strValue;
                            sheet.Cells[index, 18].Style = tmpStyle;

                            strValue = dt.Compute("SUM(AF_SUM)", "DATA_TYPE='" + strType2 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                            sheet.Cells[index, 19].Value = strValue;
                            sheet.Cells[index, 19].Style = tmpStyle;

                            strValue = dt.Compute("SUM(OF1_SET_WEIGHT)", "DATA_TYPE='" + strType2 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                            sheet.Cells[index, 20].Value = strValue;
                            sheet.Cells[index, 20].Style = tmpStyle;

                            strValue = dt.Compute("SUM(OF2_SET_WEIGHT)", "DATA_TYPE='" + strType2 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                            sheet.Cells[index, 21].Value = strValue;
                            sheet.Cells[index, 21].Style = tmpStyle;

                            strValue = dt.Compute("SUM(OF_SUM)", "DATA_TYPE='" + strType2 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                            sheet.Cells[index, 22].Value = strValue;
                            sheet.Cells[index, 22].Style = tmpStyle;

                            strValue = dt.Compute("SUM(ZF1_SET_WEIGHT)", "DATA_TYPE='" + strType2 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                            sheet.Cells[index, 23].Value = strValue;
                            sheet.Cells[index, 23].Style = tmpStyle;

                            strValue = dt.Compute("SUM(ZF2_SET_WEIGHT)", "DATA_TYPE='" + strType2 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                            sheet.Cells[index, 24].Value = strValue;
                            sheet.Cells[index, 24].Style = tmpStyle;

                            strValue = dt.Compute("SUM(ZF_SUM)", "DATA_TYPE='" + strType2 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                            sheet.Cells[index, 25].Value = strValue;
                            sheet.Cells[index, 25].Style = tmpStyle;

                            strValue = dt.Compute("SUM(CFD1_SET_WEIGHT)", "DATA_TYPE='" + strType2 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                            sheet.Cells[index, 26].Value = strValue;
                            sheet.Cells[index, 26].Style = tmpStyle;

                            strValue = dt.Compute("SUM(CFD2_SET_WEIGHT)", "DATA_TYPE='" + strType2 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                            sheet.Cells[index, 27].Value = strValue;
                            sheet.Cells[index, 27].Style = tmpStyle;

                            strValue = dt.Compute("SUM(CFD_SUM)", "DATA_TYPE='" + strType2 + "' and WORK_SHIFT = '" + strShiftNow + "'").ToString();
                            sheet.Cells[index, 28].Value = strValue;
                            sheet.Cells[index, 28].Style = tmpStyle;
                        }
                    }
                ...
                strValue = dt.Compute("SUM(SF7_SET_WEIGHT)", "DATA_TYPE='" + strType1 + "'").ToString();
                sheet.Cells[index, 12].Value = strValue;
                sheet.Cells[index, 12].Style = tmpStyle;

                strValue = dt.Compute("SUM(SF8_SET_WEIGHT)", "DATA_TYPE='" + strType1 + "'").ToString();
                sheet.Cells[index, 13].Value = strValue;
                sheet.Cells[index, 13].Style = tmpStyle;

                strValue = dt.Compute("SUM(SF9_SET_WEIGHT)", "DATA_TYPE='" + strType1 + "'").ToString();
                sheet.Cells[index, 14].Value = strValue;
                sheet.Cells[index, 14].Style = tmpStyle;

                strValue = dt.Compute("SUM(SF10_SET_WEIGHT)", "DATA_TYPE='" + strType1 + "'").ToString();
                sheet.Cells[index, 15].Value = strValue;
                sheet.Cells[index, 15].Style = tmpStyle;
                ...
                strValue = dt.Compute("SUM(CFD1_SET_WEIGHT)", "DATA_TYPE='" + strType1 + "'").ToString();
                sheet.Cells[index, 26].Value = strValue;
                sheet.Cells[index, 26].Style = tmpStyle;

                strValue = dt.Compute("SUM(CFD2_SET_WEIGHT)", "DATA_TYPE='" + strType1 + "'").ToString();
                sheet.Cells[index, 27].Value = strValue;
                sheet.Cells[index, 27].Style = tmpStyle;

                strValue = dt.Compute("SUM(CFD_SUM)", "DATA_TYPE='" + strType1 + "'").ToString();
                sheet.Cells[index, 28].Value = strValue;
                sheet.Cells[index, 28].Style = tmpStyle;
                ...
                if (!string.IsNullOrEmpty(strType2))
                {
                    ...
                    strValue = dt.Compute("SUM(SF7_SET_WEIGHT)", "DATA_TYPE='" + strType2 + "'").ToString();
                    sheet.Cells[index, 12].Value = strValue;
                    sheet.Cells[index, 12].Style = tmpStyle;

                    strValue = dt.Compute("SUM(SF8_SET_WEIGHT)", "DATA_TYPE='" + strType2 + "'").ToString();
                    sheet.Cells[index, 13].Value = strValue;
                    sheet.Cells[index, 13].Style = tmpStyle;

                    strValue = dt.Compute("SUM(SF9_SET_WEIGHT)", "DATA_TYPE='" + strType2 + "'").ToString();
                    sheet.Cells[index, 14].Value = strValue;
                    sheet.Cells[index, 14].Style = tmpStyle;

                    strValue = dt.Compute("SUM(SF10_SET_WEIGHT)", "DATA_TYPE='" + strType2 + "'").ToString();
                    sheet.Cells[index, 15].Value = strValue;
                    sheet.Cells[index, 15].Style = tmpStyle;
                    ...
                    strValue = dt.Compute("SUM(CFD1_SET_WEIGHT)", "DATA_TYPE='" + strType2 + "'").ToString();
                    sheet.Cells[index, 26].Value = strValue;
                    sheet.Cells[index, 26].Style = tmpStyle;

                    strValue = dt.Compute("SUM(CFD2_SET_WEIGHT)", "DATA_TYPE='" + strType2 + "'").ToString();
                    sheet.Cells[index, 27].Value = strValue;
                    sheet.Cells[index, 27].Style = tmpStyle;

                    strValue = dt.Compute("SUM(CFD_SUM)", "DATA_TYPE='" + strType2 + "'").ToString();
                    sheet.Cells[index, 28].Value = strValue;
                    sheet.Cells[index, 28].Style = tmpStyle;
                }
                #endregion
        ...
        {
            List<string> lMergeFileds = new List<string> { "RECORD_TIME", "WORK_TEAM", "BATCH_NO", "ORE_NAME" };
