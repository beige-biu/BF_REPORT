<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProdIndex_Rep_fal2.aspx.cs" Inherits="BF_ReportCS.Manager.Module.Report._1500BF.ProdIndex_Rep_fal2" %>
        ...
        <div>
            <table style="width: 100%;">
                <tr style="background-color: cornflowerblue; font-size: 15pt;">
                    <td width="100%;" height="30px" align="center" valign="center">高炉生产技经指标日报表
                    </td>
                </tr>
                <tr>
                    <td valign="top">
...
<%--                                                            <dx:GridViewDataTextColumn Caption="干焦比<br>(kg/t)" FieldName="GJB" Width="45px" ShowInCustomizationForm="false" UnboundType="String"
                                                            ...
                                                            <dx:GridViewDataTextColumn Caption="煤量" FieldName="PMB" Width="45px" ShowInCustomizationForm="false" UnboundType="String"
...
<%--                                                            <dx:GridViewDataTextColumn Caption="焦丁比<br>(kg/t)" FieldName="JDB" Width="45px" ShowInCustomizationForm="false" UnboundType="String"
                                                            ...
                                                            <dx:GridViewDataTextColumn Caption="焦量" FieldName="ZHJB" Width="60px" ShowInCustomizationForm="false" UnboundType="String"
