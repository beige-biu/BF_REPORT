...
{
    public partial class WaterSystem_Rep : System.Web.UI.Page
    {
        ...
        protected void GetData(string strHeight)
        {
            ...
            String strsql = "";
            strsql = "select * from T_RPT_RECYCLE_WATER WHERE RECORD_TIME BETWEEN TO_DATE('" + strStartTime + "','yyyy-mm-dd hh24:mi:ss') AND TO_DATE('" + strEndTime + "','yyyy-mm-dd hh24:mi:ss') order by RECORD_TIME asc";
