<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GasDustReve_Rep_1.aspx.cs" Inherits="BF_ReportCS.Manager.Module.Report._1280BF.GasDustReve_Rep_1" %>
        ...
        <div>
            <table style="width: 100%;">
                <tr style="background-color: cornflowerblue; font-size: 15pt;">
                    <td width="100%;" height="30px" align="center" valign="center">1#高炉煤气干法除尘反吹日报表
                    </td>
                </tr>
                <tr>
                    <td valign="top">
