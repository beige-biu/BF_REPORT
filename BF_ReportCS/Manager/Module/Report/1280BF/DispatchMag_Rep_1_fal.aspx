<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DispatchMag_Rep_1_fal.aspx.cs" Inherits="BF_ReportCS.Manager.Module.Report._1280BF.DispatchMag_Rep_1_fal" %>
        ...
        <div>
            <table style="width: 100%;">
                <tr style="background-color: cornflowerblue; font-size: 15pt;">
                    <td width="100%;" height="30px" align="center" valign="center">高炉调度日报表
                    </td>
                </tr>
                <tr>
                    <td valign="top">
