<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TRTDev_Rep_1.aspx.cs" Inherits="BF_ReportCS.Manager.Module.Report._1280BF.TRTDev_Rep_1" %>
        ...
        <div>
            <table style="width: 100%;">
                <tr style="background-color: cornflowerblue; font-size: 15pt;">
                    <td width="100%;" height="30px" align="center" valign="center">1#高炉TRT生产日报表
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                                                    ...
                                                    <dx:ASPxGridView ID="gridBase1" runat="server" ClientInstanceName="gridBase1" Width="100%" Theme="Office2010Blue" OnHtmlRowPrepared="gridBase1_HtmlRowPrepared" Font-Size="14px">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="透平机" VisibleIndex="3" Name="gbc1">
                                                                <Columns>
                                                                    <dx:GridViewBandColumn Caption="转速(r/min)" VisibleIndex="0" Name="gbc2">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="A" FieldName="TAG01" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="0">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="B" FieldName="TAG02" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="1">
                                                                            </dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                                    <dx:GridViewDataTextColumn Caption="静叶开度" FieldName="TAG03" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewBandColumn Caption="轴位移" VisibleIndex="2" Name="gbc3">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="A" FieldName="TAG04" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="0">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="B" FieldName="TAG05" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="1">
                                                                            </dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                                    <dx:GridViewBandColumn Caption="前轴承" VisibleIndex="3" Name="gbc4">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="振动(μm)A" FieldName="TAG06" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="0">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="振动(μm)B" FieldName="TAG07" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="1">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="温度(℃)A" FieldName="TAG10" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="2">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="温度(℃)B" FieldName="TAG11" ShowInCustomizationForm="True" UnboundType="String"
                                                                    ...
                                                                    <dx:GridViewBandColumn Caption="后轴承" VisibleIndex="4" Name="gbc5">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="振动(μm)A" FieldName="TAG08" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="0">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="振动(μm)B" FieldName="TAG09" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="1">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="温度(℃)A" FieldName="TAG12" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="2">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="温度(℃)B" FieldName="TAG13" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="3">
                                                                            </dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                                    <dx:GridViewBandColumn Caption="止推轴承" VisibleIndex="5" Name="gbc6">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="温度(℃)A" FieldName="TAG14" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="0">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="温度(℃)B" FieldName="TAG15" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="1">
                                                                            </dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="动力油系统" VisibleIndex="6" Name="gbc7">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="总管压力(kPa)	" FieldName="TAG16" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="0">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="液位(%)" FieldName="TAG17" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="温度(℃)" FieldName="TAG18" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="2">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <dx:GridViewBandColumn Caption="润滑油系统" VisibleIndex="7" Name="gbc8">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="远端油压(kPa)	" FieldName="TAG19" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="0">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="液位(%)" FieldName="TAG20" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="温度(℃)" FieldName="TAG21" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="2">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="冷却器温度(℃)" FieldName="TAG22" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="3">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="远端油温(℃)" FieldName="TAG23" ShowInCustomizationForm="True" UnboundType="String"
                                                            ...
                                                            <dx:GridViewBandColumn Caption="煤气系统" VisibleIndex="8" Name="gbc9">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="煤气流量(Nm3/h)" FieldName="TAG24" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="0">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="高炉顶压(kPa)" FieldName="TAG25" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewBandColumn Caption="煤气压力(kPa)" VisibleIndex="2" Name="gbc10">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="透平入口" FieldName="TAG26" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="0">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="透平出口" FieldName="TAG27" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="1">
                                                                            </dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                                    <dx:GridViewBandColumn Caption="煤气温度(℃)" VisibleIndex="3" Name="gbc11">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="透平入口" FieldName="TAG28" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="0">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="透平出口" FieldName="TAG29" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="1">
                                                                            </dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="发电机" VisibleIndex="9" Name="gbc12">
                                                                <Columns>
                                                                    <dx:GridViewBandColumn Caption="冷却温度(℃)" VisibleIndex="0" Name="gbc13">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="左进风" FieldName="TAG30" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="0">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="右进风" FieldName="TAG31" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="1">
                                                                            </dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                                    <dx:GridViewBandColumn Caption="定子线圈温度(℃)" VisibleIndex="1" Name="gbc14">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="温度1" FieldName="TAG32" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="0">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="温度2" FieldName="TAG33" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="1">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="温度3" FieldName="TAG34" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="2">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="温度4" FieldName="TAG35" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="3">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="温度5" FieldName="TAG36" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="4">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="温度6" FieldName="TAG37" ShowInCustomizationForm="True" UnboundType="String"
                                                                    ...
                                                                    <dx:GridViewBandColumn Caption="定子铁芯温度(℃)" VisibleIndex="2" Name="gbc15">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="温度1" FieldName="TAG38" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="0">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="温度2" FieldName="TAG39" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="1">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="温度3" FieldName="TAG40" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="2">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="温度4" FieldName="TAG41" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="3">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="温度5" FieldName="TAG42" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="4">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="温度6" FieldName="TAG43" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="5">
                                                                            </dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
