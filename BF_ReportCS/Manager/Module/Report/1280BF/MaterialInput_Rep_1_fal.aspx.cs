...
namespace BF_ReportCS.Manager.Module.Report._1280BF
{
    public partial class MaterialInput_Rep_1_fal : System.Web.UI.Page
    {
        ...
        protected void GetData()
        {
            ...
            //原始代码
            strSQL = " SELECT to_char(a.RECORD_TIME,'yyyy-MM-dd') as DATETIME,a.* FROM l2bf_db.DAY_RLYRL_FAL  a WHERE TO_CHAR(RECORD_TIME,'YYYY-MM-DD HH24:MI:SS') BETWEEN '" + strStartTime + "' AND '" + strEndTime + "'  ";
