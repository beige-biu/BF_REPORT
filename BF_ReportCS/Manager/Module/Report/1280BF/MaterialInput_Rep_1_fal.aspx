<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaterialInput_Rep_1_fal.aspx.cs" Inherits="BF_ReportCS.Manager.Module.Report._1280BF.MaterialInput_Rep_1_fal" %>
                                                    ...
                                                    <dx:ASPxGridView ID="gridBase1" runat="server" ClientInstanceName="gridBase1" Width="100%" Theme="Office2010Blue" OnHtmlRowPrepared="gridBase1_HtmlRowPrepared" Font-Size="14px">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="烧结矿" VisibleIndex="3" Name="gbc1">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="实际重量" FieldName="SUM_SF" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="理论重量" FieldName="SUM_SF2" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="球团矿" VisibleIndex="4" Name="gbc2">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="球团总湿重" FieldName="SUM_AF" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                    ...
                                                                    <dx:GridViewDataTextColumn Caption="球1干重" FieldName="AF_WEIGHT1" ShowInCustomizationForm="True" UnboundType="String"
                                                                    ...
                                                                    <dx:GridViewDataTextColumn Caption="球2干重" FieldName="AF_WEIGHT2" ShowInCustomizationForm="True" UnboundType="String"
                                                            ...
                                                            <dx:GridViewBandColumn Caption="块矿" VisibleIndex="5" Name="gbc3">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="块矿总湿重" FieldName="SUM_OF" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="块1品名" FieldName="OF_NAME1" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="1">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="块1干重" FieldName="OF_WEIGHT1" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="2" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="块2品名" FieldName="OF_NAME2" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="3">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="块2干重" FieldName="OF_WEIGHT2" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="4" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            ...
                                                            <dx:GridViewDataTextColumn Caption="实际焦量" FieldName="SUM_COKE" Width="65px" ShowInCustomizationForm="false" UnboundType="String"
                                                                VisibleIndex="8" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="实际干焦" FieldName="SUM_DRY_COKE" Width="65px" ShowInCustomizationForm="false" UnboundType="String"
                                                            ...
                                                            <dx:GridViewBandColumn Caption="焦炭1" VisibleIndex="10" Name="gbc5">
                                                                <Columns>
                                                                    ...
                                                                    <dx:GridViewDataTextColumn Caption="理论干重" FieldName="COKE_WEIGHT1" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="2" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <dx:GridViewBandColumn Caption="焦炭2" VisibleIndex="11" Name="gbc6">
                                                                <Columns>
                                                                    ...
                                                                    <dx:GridViewDataTextColumn Caption="理论干重" FieldName="COKE_WEIGHT2" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="2" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <dx:GridViewBandColumn Caption="焦炭3" VisibleIndex="12" Name="gbc7">
                                                                <Columns>
                                                                    ...
                                                                    <dx:GridViewDataTextColumn Caption="理论干重" FieldName="COKE_WEIGHT3" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="2" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <dx:GridViewDataTextColumn Caption="焦丁" FieldName="SUM_CFD" ShowInCustomizationForm="false" UnboundType="String"
                                                                        Width="65px" VisibleIndex="13" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="外购焦丁" FieldName="SUM_CFD2" ShowInCustomizationForm="false" UnboundType="String"
