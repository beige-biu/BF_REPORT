...
{
    public partial class HSChange_Rep_1 : System.Web.UI.Page
    {
        ...
        protected void GetData()
        {
            ...
            string strSQL = "";    
            strSQL = "select * from L2BF_DB.day_hotstove_change  where RECORD_TIME between to_date('" + strStartTime + "', 'yyyy-mm-dd hh24:mi:ss') and to_date('" + strEndTime + "', 'yyyy-mm-dd hh24:mi:ss') ";
