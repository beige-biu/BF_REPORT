...
{
    public partial class WaterSystem_Rep_1 : System.Web.UI.Page
    {
        ...
        protected void GetData()
        {
            ...
            string strsql="";
            strsql = " select * from l2bf_db.DAY_WPS  WHERE RECORD_TIME BETWEEN TO_DATE('" + strStartTime + "','yyyy-mm-dd hh24:mi:ss') AND TO_DATE('" + strEndTime + "','yyyy-mm-dd hh24:mi:ss') ";
