<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaterialInput_Rep_1.aspx.cs" Inherits="BF_ReportCS.Manager.Module.Report._1280BF.MaterialInput_Rep" %>
                                                ...
                                                <dx:PanelContent ID="PanelContent1" runat="server" SupportsDisabledAttribute="True">
                                                    <dx:ASPxGridView ID="gridBase1" runat="server" ClientInstanceName="gridBase1" Width="100%" Theme="Office2010Blue" OnHtmlRowPrepared="gridBase1_HtmlRowPrepared" Font-Size="14px">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dx:GridViewDataTextColumn Caption="实际湿焦" FieldName="SUM_COKE" Width="65px" ShowInCustomizationForm="false" UnboundType="String"
