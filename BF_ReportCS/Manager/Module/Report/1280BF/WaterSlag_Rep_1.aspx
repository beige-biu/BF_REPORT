<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WaterSlag_Rep_1.aspx.cs" Inherits="BF_ReportCS.Manager.Module.Report._1280BF.WaterSlag_Rep_1" %>
                                                    ...
                                                    <dx:ASPxGridView ID="gridBase1" runat="server" ClientInstanceName="gridBase1" Width="100%" Theme="Office2010Blue" OnHtmlRowPrepared="gridBase1_HtmlRowPrepared" Font-Size="14px">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="喷淋水管" VisibleIndex="3">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="流量" FieldName="F_LSG" ShowInCustomizationForm="True" UnboundType="String"
                                                            ...
                                                            <dx:GridViewBandColumn Caption="新水补水管" VisibleIndex="4">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="流量" FieldName="F_SCXS" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <dx:GridViewBandColumn Caption="冲渣泵组" VisibleIndex="5">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="流量" FieldName="F_CZB" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="温度" FieldName="T_CZB" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="1" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="压力" FieldName="P_CZB" ShowInCustomizationForm="True" UnboundType="String"
                                                            ...
                                                            <dx:GridViewBandColumn Caption="热水泵组" VisibleIndex="6">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="流量" FieldName="F_RSB" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="温度" FieldName="T_RSB" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="1" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="压力" FieldName="P_RSB" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="2" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:GridViewBandColumn>
                                                            <dx:GridViewBandColumn Caption="A相电流变送" VisibleIndex="7">
                                                                <Columns>
                                                                    <dx:GridViewBandColumn Caption="冲渣泵" VisibleIndex="0">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="1号" FieldName="A_CZB1" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="2号" FieldName="A_CZB2" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="1" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                            </dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                                    <dx:GridViewBandColumn Caption="热水泵" VisibleIndex="1">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="A(kPa)" FieldName="A_RSB1" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="B(kPa)" FieldName="A_RSB2" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="1" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                            </dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="1号冲渣泵" VisibleIndex="8">
                                                                <Columns>
                                                                    <dx:GridViewBandColumn Caption="轴承温度" VisibleIndex="0">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="前" FieldName="T_CZB1_QZC" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="后" FieldName="T_CZB1_HZC" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="1" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                            </dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                                    <dx:GridViewBandColumn Caption="定子温度" VisibleIndex="1">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="U" FieldName="T_CZB1_U1" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="V" FieldName="T_CZB1_V1" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="1" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="W" FieldName="T_CZB1_W1" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="2" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                            </dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="2号冲渣泵" VisibleIndex="9">
                                                                <Columns>
                                                                    <dx:GridViewBandColumn Caption="轴承温度" VisibleIndex="0">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="前" FieldName="T_CZB2_QZC" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="后" FieldName="T_CZB2_HZC" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="1" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                            </dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                                    <dx:GridViewBandColumn Caption="定子温度" VisibleIndex="1">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="U" FieldName="T_CZB2_U1" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="V" FieldName="T_CZB2_V1" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="1" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="W" FieldName="T_CZB2_W1" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="2" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                            </dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="1号热水泵" VisibleIndex="10">
                                                                <Columns>
                                                                    <dx:GridViewBandColumn Caption="轴承温度" VisibleIndex="0">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="前" FieldName="T_RSB1_QZC" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="后" FieldName="T_RSB1_HZC" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="1" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                            </dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                                    <dx:GridViewBandColumn Caption="定子温度" VisibleIndex="1">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="U" FieldName="T_RSB1_U1" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="V" FieldName="T_RSB1_V1" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="1" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="W" FieldName="T_RSB1_W1" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="2" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                            </dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                            ...
                                                            <dx:GridViewBandColumn Caption="2号热水泵" VisibleIndex="11">
                                                                <Columns>
                                                                    <dx:GridViewBandColumn Caption="轴承温度" VisibleIndex="0">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="前" FieldName="T_RSB2_QZC" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="后" FieldName="T_RSB2_HZC" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="1" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                            </dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
                                                                    <dx:GridViewBandColumn Caption="定子温度" VisibleIndex="1">
                                                                        <Columns>
                                                                            <dx:GridViewDataTextColumn Caption="U" FieldName="T_RSB2_U1" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="V" FieldName="T_RSB2_V1" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="1" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                            </dx:GridViewDataTextColumn>
                                                                            <dx:GridViewDataTextColumn Caption="W" FieldName="T_RSB2_W1" ShowInCustomizationForm="True" UnboundType="String"
                                                                                Width="65px" VisibleIndex="2" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                            </dx:GridViewDataTextColumn>
                                                                        </Columns>
                                                                    </dx:GridViewBandColumn>
