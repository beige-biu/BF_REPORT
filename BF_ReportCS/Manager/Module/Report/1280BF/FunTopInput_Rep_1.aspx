<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FunTopInput_Rep_1.aspx.cs" Inherits="BF_ReportCS.Manager.Module.Report._1280BF.FunTopInput_Rep_1" %>
                                                ...
                                                <dx:PanelContent ID="PanelContent1" runat="server" SupportsDisabledAttribute="True">
                                                    <dx:ASPxGridView ID="gridBase1" runat="server" ClientInstanceName="gridBase1" Width="100%" Theme="Office2010Blue" OnHtmlRowPrepared="gridBase1_HtmlRowPrepared" Font-Size="14px">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dx:GridViewDataTextColumn Caption="批号" FieldName="CHARGE_NO" Name="CHARGE_NO" Width="65px" ShowInCustomizationForm="false" UnboundType="String"
                                                                VisibleIndex="3">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="料种" FieldName="ORE_NAME"  Name="ORE_NAME" Width="65px" ShowInCustomizationForm="false" UnboundType="String"
                                                                VisibleIndex="4">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="料罐重(t)" FieldName="DUMP_WEIGHT"  Name="DUMP_WEIGHT" Width="65px" ShowInCustomizationForm="false" UnboundType="String"  
                                                                VisibleIndex="5" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="启始角" FieldName="RING_B_INI" Width="65px"  Name="RING_B_INI" ShowInCustomizationForm="false" UnboundType="String"
                                                                VisibleIndex="6" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="β总圈数" FieldName="RING_B_TOTAL" Width="65px" Name="RING_B_TOTAL"  ShowInCustomizationForm="false" UnboundType="String"
                                                                VisibleIndex="7" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="开度r" FieldName="RING_R" Width="65px"  Name="RING_R" ShowInCustomizationForm="false" UnboundType="String"
                                                                VisibleIndex="8" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewBandColumn Caption="下尺料线" VisibleIndex="9" Name="9">
                                                                <Columns>
                                                                    <dx:GridViewDataTextColumn Caption="东" FieldName="SD1_DOWN_LINE" Name="SD1_DOWN_LINE" ShowInCustomizationForm="True" UnboundType="String"
                                                                        Width="65px" VisibleIndex="0" PropertiesTextEdit-DisplayFormatString="{0:0.00}">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="西" FieldName="SD2_DOWN_LINE" Name="SD2_DOWN_LINE" ShowInCustomizationForm="True" UnboundType="String"
                                                            ...
                                                            <dx:GridViewDataTextColumn Caption="布料标志" FieldName="DUMP_FLAG" Name="DUMP_FLAG" Width="65px" ShowInCustomizationForm="false" UnboundType="String"
                                                                VisibleIndex="12">
                                                            </dx:GridViewDataTextColumn>
                                                            <dx:GridViewDataTextColumn Caption="布料方式" FieldName="DUMP_WAY" Name="DUMP_WAY" Width="125px" ShowInCustomizationForm="false" UnboundType="String"
                                                                VisibleIndex="13">
                                                            </dx:GridViewDataTextColumn>
                                                        </Columns>
                                                        <GroupSummary>
