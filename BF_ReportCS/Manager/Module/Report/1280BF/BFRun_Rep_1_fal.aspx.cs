...
{
    public partial class BFRun_Rep_1_fal : System.Web.UI.Page
    {
        ...
        protected void GetData()
        {
            ...
            //}
            //原始代码
            strSQL = "select a.*,(RICH_OXY_AMOUNT-R_LG_ACTIVE) as RICH_OXY_AMOUNT from l2bf_db.day_handlepara_fal a where RECORD_TIME between to_date('" + strStartTime + "', 'yyyy-mm-dd hh24:mi:ss') and to_date('" + strEndTime + "', 'yyyy-mm-dd hh24:mi:ss') ";
            strSQL += " order by RECORD_TIME asc";
